{
  ...
  char* xtitle1D[Num1DHists] = {
    "Generated Upper Muon p_{T} [GeV]",
    "Generated Upper Muon #eta",
    "Generated Upper Muon #phi",
    "Generated Upper Muon Charge",
    "Generated Lower Muon p_{T} [GeV]",
    "Generated Lower Muon #eta",
    "Generated Lower Muon #phi",
    "Generated Lower Muon Charge",
    "Angle Between Two Generated Muons"
  };
  ...
  */
  ...
  for (int a=0; a<NumFiles; a++){
    ...
    HAll1D[a][0]->GetXaxis()->SetRangeUser(0,600);
    HAll1D[a][4]->GetXaxis()->SetRangeUser(0,600);
  ...
  */
  ...
  for (int a=0; a<NumFiles; a++){
    for(int i=0; i<Num1DHists; i++){
      if(i==0 || i==1 || i==2 || i==4 || i==5 || i==6) HAll1D[a][i]->GetYaxis()->SetRangeUser(1,10000); 
    }
  }
