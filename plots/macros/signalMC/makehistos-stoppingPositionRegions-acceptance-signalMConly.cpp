{
  ...
  //all that stop
  //stops
  //Float_t regionTotal[n_detectorRegions] = {430,1316,142,4095,949,6018,1831,41,1632};
  //Float_t regionPreselectionAcc[n_detectorRegions] = {71,79,2,149,15,37,11,2,0};
  //gluinos
  //Float_t regionTotal[n_detectorRegions] = {346,1517,178,6281,1364,8350,2768,44,2260};
  //Float_t regionPreselectionAcc[n_detectorRegions] = {1,0,0,0,0,0,0,0,0};
  //mchamps
  //Float_t regionTotal[n_detectorRegions] = {662,2015,192,5113,1264,6071,2355,56,1713};
  //Float_t regionPreselectionAcc[n_detectorRegions] = {183,212,6,198,19,41,12,4,0};
  //gmstaus
  //Float_t regionTotal[n_detectorRegions] = {108,360,37,1104,197,1823,406,11,485};
  //Float_t regionPreselectionAcc[n_detectorRegions] = {8,15,0,35,1,9,2,0,0};
  //ppstaus
  Float_t regionTotal[n_detectorRegions] = {7,53,1,325,23,750,92,1,223};
  Float_t regionPreselectionAcc[n_detectorRegions] = {1,4,0,7,1,4,0,0,0};

  TString regionLabels[n_detectorRegions] = {"Tracker","EB","EE","HB","HE","MB","ME","Other","Walls"};

  for(int z=0; z<n_detectorRegions; z++){
    HAll1D[0][0]->SetBinContent(z+1,1.*regionTotal[z]);
    HAll1D[1][0]->SetBinContent(z+1,1.*regionPreselectionAcc[z]);
  ...
  char* LegFile[NumFiles] = {"All that stop","Pass preselection"};
  ...
  */
  ...
  //for(int i=0; i<17; i++){
    ...
    */
    ...
    //sprintf(canvasesEPS,"../../plots/StoppedHSCPMuon/RecoData/signalMC/stops/%sstop500_neutralino316.eps",plot1D[i]);
    //sprintf(canvasesEPS,"../../plots/StoppedHSCPMuon/RecoData/signalMC/gluinos/%sgluino500_neutralino387.eps",plot1D[i]);
    //sprintf(canvasesEPS,"../../plots/StoppedHSCPMuon/RecoData/signalMC/mchamps/%smchamp500.eps",plot1D[i]);
    //sprintf(canvasesEPS,"../../plots/StoppedHSCPMuon/RecoData/signalMC/gmstaus/%sgmstau494_gravitinop0001.eps",plot1D[i]);
    sprintf(canvasesEPS,"../../plots/StoppedHSCPMuon/RecoData/signalMC/ppstaus/%sppstau494_gravitinop0001.eps",plot1D[i]);
