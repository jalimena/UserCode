{
  ...
  TFile f2 ("/home/alimena/histos/ppstau247_gravitinop0001_reducedNtuples_724/wBxCut_woCavCut_woGenMuCut_woSACut_woGenMuMatchedCut_woTriggerCut_woPtCut_woChaCut_woEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut__woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  TFile f3 ("/home/alimena/histos/ppstau494_gravitinop0001_reducedNtuples_724/wBxCut_woCavCut_woGenMuCut_woSACut_woGenMuMatchedCut_woTriggerCut_woPtCut_woChaCut_woEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut__woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  ...
  char* plot1D[Num1DHists] = {
    ...
    "mcStauBeta_", //8
    "stopped_mcStauP_", //9
    "stopped_mcStauPt_", //10
    "stopped_mcStauBeta_", //11
    "notStopped_mcStauP_", //12
    "notStopped_mcStauPt_", //13
    "notStopped_mcStauBeta_" //14
  };

  char* xtitle1D[Num1DHists] = {
    "Number of Generated Staus",
    "Generator Stau p [GeV]",
    "Generator Stau p_{x} [GeV]",
    "Generator Stau p_{y} [GeV]",
    "Generator Stau p_{z} [GeV]",
  ...
  */
  ...
  char* LegFile[NumFiles] = {"100 GeV staus, direct pair production","247 GeV staus, direct pair production","494 GeV staus, direct pair production"};
  ...
  char LegEntry[100];
  Leg2 = new TLegend(0.30,0.65,0.55,0.80);
  for (int a=0; a<NumFiles; a++){
    sprintf(LegEntry,"%s",LegFile[a]);
  ...
  */
  ...
  for (int a=0; a<NumFiles; a++){
    //linear
    HAll1D[a][1]->GetYaxis()->SetRangeUser(0,6500);

    HAll1D[a][11]->GetYaxis()->SetRangeUser(0,600);

    HAll1D[a][12]->GetYaxis()->SetRangeUser(0,6500);
    HAll1D[a][13]->GetYaxis()->SetRangeUser(0,6500);
    ...
    HAll1D[a][9]->GetYaxis()->SetRangeUser(1,1000000);
    HAll1D[a][10]->GetYaxis()->SetRangeUser(1,1000000);
    HAll1D[a][11]->GetYaxis()->SetRangeUser(1,1000000);

    HAll1D[a][12]->GetYaxis()->SetRangeUser(1,1000000);
    HAll1D[a][13]->GetYaxis()->SetRangeUser(1,1000000);
