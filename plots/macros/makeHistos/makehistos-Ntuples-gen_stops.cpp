{
  ...
  TFile f2 ("/home/alimena/histos/stop500_neutralino316_reducedNtuples_724/wBxCut_woCavCut_woGenMuCut_woSACut_woGenMuMatchedCut_woTriggerCut_woPtCut_woChaCut_woEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut__woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  TFile f3 ("/home/alimena/histos/stop1000_neutralino819_reducedNtuples_724/wBxCut_woCavCut_woGenMuCut_woSACut_woGenMuMatchedCut_woTriggerCut_woPtCut_woChaCut_woEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut__woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  ...
  char* plot1D[Num1DHists] = {
    ...
    "mcStopBeta_", //8
    "stopped_mcStopP_", //9
    "stopped_mcStopPt_", //10
    "stopped_mcStopBeta_", //11
    "notStopped_mcStopP_", //12 
    "notStopped_mcStopPt_", //13 
    "notStopped_mcStopBeta_" //14                
  };

  char* xtitle1D[Num1DHists] = {
    "Number of Generated Stops",
    "Generator Stop p [GeV]",
    "Generator Stop p_{x} [GeV]",
    "Generator Stop p_{y} [GeV]",
    "Generator Stop p_{z} [GeV]",
  ...
  */
  ...
  char axistitles[200];
  for(int a=0; a<NumFiles; a++){
    cout<<"There are "<<HAll1D[a][9]->GetEntries()<<" entries in the HAll1D["<<a<<"][9]"<<endl;
    cout<<"There are "<<HAll1D[a][11]->GetEntries()<<" entries in the HAll1D["<<a<<"][11]"<<endl;
    HAll1D[a][1]->GetXaxis()->SetNdivisions(505);
    HAll1D[a][5]->GetXaxis()->SetNdivisions(505);
    HAll1D[a][9]->GetXaxis()->SetNdivisions(505);
    HAll1D[a][10]->GetXaxis()->SetNdivisions(505);
    HAll1D[a][12]->GetXaxis()->SetNdivisions(505);
    HAll1D[a][13]->GetXaxis()->SetNdivisions(505);
    for(int i=0; i<Num1DHists; i++){
  ...
  */
  for (int a=0; a<NumFiles; a++){
    ...
    HAll1D[a][12]->Rebin(10);
    HAll1D[a][13]->Rebin(10);
    ...
    */
    ...
    //linear
    HAll1D[a][1]->GetXaxis()->SetRangeUser(0,2000);
    HAll1D[a][5]->GetXaxis()->SetRangeUser(0,2000);
    HAll1D[a][9]->GetXaxis()->SetRangeUser(0,2000);
    HAll1D[a][10]->GetXaxis()->SetRangeUser(0,2000);
    HAll1D[a][12]->GetXaxis()->SetRangeUser(0,2000);
    HAll1D[a][13]->GetXaxis()->SetRangeUser(0,2000);

    /*
    //log
    HAll1D[a][1]->GetXaxis()->SetRangeUser(0,3000);
    HAll1D[a][5]->GetXaxis()->SetRangeUser(0,3000);
    HAll1D[a][9]->GetXaxis()->SetRangeUser(0,3000);
    HAll1D[a][10]->GetXaxis()->SetRangeUser(0,3000);
    HAll1D[a][12]->GetXaxis()->SetRangeUser(0,3000);
    HAll1D[a][13]->GetXaxis()->SetRangeUser(0,3000);
    */
   }    
  ...
  char* LegFile[NumFiles] = {"100 GeV stops","500 GeV stops","1000 GeV stops"};
  ...
  char LegEntry[100];
  Leg2 = new TLegend(0.4,0.65,0.65,0.80);
  for (int a=0; a<NumFiles; a++){
    sprintf(LegEntry,"%s",LegFile[a]);
  ...
  */
  ...
  for(int i=0; i<Num1DHists; i++){
    ...
    */
    ...
    HAll1D[1][i]->Scale(0.5); //stop500 has twice as many events as stop100 and stop 1000
  ...
  */
  ...
  for (int a=0; a<NumFiles; a++){
    ...
    HAll1D[a][1]->GetYaxis()->SetRangeUser(0,12000);
    HAll1D[a][5]->GetYaxis()->SetRangeUser(0,12000);
    HAll1D[a][8]->GetYaxis()->SetRangeUser(0,10000);

    HAll1D[a][9]->GetYaxis()->SetRangeUser(0,4000);
    HAll1D[a][10]->GetYaxis()->SetRangeUser(0,4000);
    HAll1D[a][11]->GetYaxis()->SetRangeUser(0,1000);

    HAll1D[a][12]->GetYaxis()->SetRangeUser(0,12000);
    HAll1D[a][13]->GetYaxis()->SetRangeUser(0,12000);
    HAll1D[a][14]->GetYaxis()->SetRangeUser(0,10000);
    

    /*
    //if using log scale
    HAll1D[a][1]->GetYaxis()->SetRangeUser(1,5000000);
    HAll1D[a][5]->GetYaxis()->SetRangeUser(1,5000000);
    HAll1D[a][8]->GetYaxis()->SetRangeUser(1,5000000);

    HAll1D[a][9]->GetYaxis()->SetRangeUser(1,5000000);
    HAll1D[a][10]->GetYaxis()->SetRangeUser(1,5000000);
    HAll1D[a][11]->GetYaxis()->SetRangeUser(1,5000000);

    HAll1D[a][12]->GetYaxis()->SetRangeUser(1,5000000);
    HAll1D[a][13]->GetYaxis()->SetRangeUser(1,5000000);
    HAll1D[a][14]->GetYaxis()->SetRangeUser(1,5000000);
    */
  }
