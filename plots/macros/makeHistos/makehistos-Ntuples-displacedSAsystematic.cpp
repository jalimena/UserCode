{
  ...
  char* plot1D[Num1DHists] = {
    "muDisplacedStandAlonePt_GlSAnumerator_",
    "muDisplacedStandAlonePt_GlSAdenominator_"
  };

  char* xtitle1D[Num1DHists] = {
    "Displaced SA Muon p_{T} [GeV]",
    "Displaced SA Muon p_{T} [GeV]"
  };
  ...
  eff_graph->SetTitle(";Displaced SA p_{T} [GeV];Efficiency");
  ...
  eff_graph->GetYaxis()->SetRangeUser(0.,.01);
