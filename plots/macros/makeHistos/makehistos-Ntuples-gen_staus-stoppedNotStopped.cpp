{
  ...
  //TFile f1 ("/home/alimena/histos/gmstau247_gravitinop0001_reducedNtuples_724/wBxCut_woCavCut_woGenMuCut_woSACut_woGenMuMatchedCut_woTriggerCut_woPtCut_woChaCut_woEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut__woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  //TFile f1 ("/home/alimena/histos/gmstau494_gravitinop0001_reducedNtuples_724/wBxCut_woCavCut_woGenMuCut_woSACut_woGenMuMatchedCut_woTriggerCut_woPtCut_woChaCut_woEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut__woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");


  //TFile f1 ("/home/alimena/histos/ppstau100_gravitinop0001_reducedNtuples_724/wBxCut_woCavCut_woGenMuCut_woSACut_woGenMuMatchedCut_woTriggerCut_woPtCut_woChaCut_woEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut__woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  //TFile f1 ("/home/alimena/histos/ppstau247_gravitinop0001_reducedNtuples_724/wBxCut_woCavCut_woGenMuCut_woSACut_woGenMuMatchedCut_woTriggerCut_woPtCut_woChaCut_woEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut__woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  TFile f1 ("/home/alimena/histos/ppstau494_gravitinop0001_reducedNtuples_724/wBxCut_woCavCut_woGenMuCut_woSACut_woGenMuMatchedCut_woTriggerCut_woPtCut_woChaCut_woEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut__woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  ...
  char* plot1DStopped[Num1DHists] = {
    "stopped_mcStauP_", //0
    "stopped_mcStauPt_", //1
    "stopped_mcStauBeta_" //2
  };
  char* plot1DNotStopped[Num1DHists] = {
    "notStopped_mcStauP_", //0 
    "notStopped_mcStauPt_", //1 
    "notStopped_mcStauBeta_" //2                
  };

  char* xtitle1D[Num1DHists] = {
    "Generator Stau p [GeV]",
    "Generator Stau p_{T} [GeV]",
    "Generator Stau #beta"
  };
  ...
  */
  ...
  //Leg1 = new TLegend(0.18,0.65,0.50,0.80,"100 GeV staus, cascade decays:");
  //Leg1 = new TLegend(0.18,0.65,0.50,0.80,"247 GeV staus, cascade decays:");
  //Leg1 = new TLegend(0.18,0.65,0.50,0.80,"494 GeV staus, cascade decays:");

  //Leg1 = new TLegend(0.18,0.65,0.50,0.80,"100 GeV staus, direct pair production:");
  //Leg1 = new TLegend(0.18,0.65,0.50,0.80,"247 GeV staus, direct pair production:");
  Leg1 = new TLegend(0.18,0.65,0.50,0.80,"494 GeV staus, direct pair production:");
  for (int a=0; a<NumFiles; a++){
  ...
  char LegEntry[100];
  //Leg2 = new TLegend(0.34,0.65,0.60,0.80,"100 GeV staus, cascade decays:");
  //Leg2 = new TLegend(0.34,0.65,0.60,0.80,"247 GeV staus, cascade decays:");
  //Leg2 = new TLegend(0.34,0.65,0.60,0.80,"494 GeV staus, cascade decays:");

  //Leg2 = new TLegend(0.35,0.65,0.60,0.80,"100 GeV staus, direct pair production:");
  //Leg2 = new TLegend(0.35,0.65,0.60,0.80,"247 GeV staus, direct pair production:");
  Leg2 = new TLegend(0.34,0.65,0.60,0.80,"494 GeV staus, direct pair production:");
  ...
  */
  ...
  for (int a=0; a<NumFiles; a++){
    HAll1D[a][0]->GetYaxis()->SetRangeUser(0.5,100000);
    HAll1D[a][1]->GetYaxis()->SetRangeUser(0.5,100000);
    HAll1D[a][2]->GetYaxis()->SetRangeUser(0.5,100000);
