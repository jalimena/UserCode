{
  ...
  char* plot1D[Num1DHists] = {
    ...
    "inversePtResolution_L2Mu20_NoVertex_3Sta_NoBPTX3BX_NoHalo" //4
  ...
  */
  for (int a=0; a<NumFiles; a++){
    ...
    HAll1D[a][3]->GetXaxis()->SetRangeUser(-1.2,3);
    /*
  ...
  //char* LegFile[NumFiles] = {"Generator","L2 Configuration in 2012","L1 and L2 Improvements for 2015"};
  //char* LegFile[NumFiles] = {"2012 Configuration","L1 and HLT Improvements for 2015"};
  char* LegFile[NumFiles] = {"2012 L1 and HLT","2015 L1 and HLT"};
  ...
  Leg1 = new TLegend(0.6,0.75,0.90,0.92);
  for (int a=0; a<NumFiles; a++){
  ...
  TPaveLabel *textInfo = new TPaveLabel(.55,.75,.90,.8,"0 GeV < p_{T} < 250 GeV","NDC");
  textInfo->SetBorderSize(0);
  textInfo->SetTextSize(0.7);
  textInfo->SetFillColor(0);
  ...
  */
  ...
  if (save_plots) canvases1D[3]->SaveAs("../plots/TriggerObjects/inversePtResolution_GenHlt_NoBPTX_mchamp500.eps");
