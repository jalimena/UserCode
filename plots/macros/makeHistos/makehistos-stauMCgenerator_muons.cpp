{
  ...
  char* plot[NumHists] = {"_Nmu","_mustatus","_mupt","_mueta","_muphi","_muvtxX","_muvtxY","_muvtxZ"};
  char* xtitle[NumHists] = {"Number of Muons","MC status of muons","Muon Generator p_{T} [GeV]","Muon Generator #eta","Muon Generator #phi","Muon Generator x-coordinate of vertex [cm]","Muon Generator y-coordinate of vertex [cm]","Muon Generator z-coordinate of vertex [cm]"};
  ...
  for(int i=0; i<NumHists; i++){
    ...
    sprintf(canvasesEPS,"../plots/stauMCgenerator/muons/%s.eps",plot[i]);
