{
  ...
  */
  ...
  HAll1D[1][8]->SetLineColor(1); //cosmic pt, 71X //best 3
  HAll1D[2][0]->SetLineColor(2); //SA pt, 71X cosSeed + SA traj //best 3// absolute best
  HAll1D[2][4]->SetLineColor(4); //RSA pt, 71X cosSeed + SA traj //best 3

  HAll1D[1][8]->SetLineStyle(1); //cosmic pt, 71X //best 3
  HAll1D[2][0]->SetLineStyle(2); //SA pt, 71X cosSeed + SA traj //best 3// absolute best
  HAll1D[2][4]->SetLineStyle(3); //RSA pt, 71X cosSeed + SA traj //best 3
  ...
  char* LegFile[NumFiles] = {"53X","71X","71X, cosSeed, SA traj","71X, cosSeed, Exhaustive traj"};
  char LegEntry[100];
  Leg1 = new TLegend(0.60,0.8,0.95,0.98);
  for (int a=0; a<NumFiles; a++){
    sprintf(LegEntry,"%s",LegFile[a]);
    Leg1->AddEntry(HAll1D[a][0],LegEntry,"p");
  }
  Leg1->SetBorderSize(0);
  Leg1->SetTextSize(0.03);
  Leg1->SetFillColor(0);

  HAll1D[0][0]->SetLineColor(1);//SA pt, 53X
  HAll1D[0][4]->SetLineColor(2);//RSA pt, 53X
  HAll1D[0][8]->SetLineColor(4);//cosmic pt, 53X
  HAll1D[2][0]->SetLineColor(6); //SA pt, 71X cosSeed + SA traj //best 3// absolute best
  HAll1D[2][4]->SetLineColor(8); //RSA pt, 71X cosSeed + SA traj //best 3
  HAll1D[1][8]->SetLineColor(11); //cosmic pt, 71X //best 3


  Leg2 = new TLegend(0.60,0.8,0.95,0.98);
  Leg2->AddEntry(HAll1D[0][0],"53X, SA Reco","l");
  Leg2->AddEntry(HAll1D[0][4],"53X, RSA Reco","l");
  Leg2->AddEntry(HAll1D[0][8],"53X, Cosmic Reco","l");
  Leg2->AddEntry(HAll1D[2][0],"71X, cosSeed, SA traj","l");
  Leg2->AddEntry(HAll1D[2][4],"71X, cosSeed, RSA traj","l");
  Leg2->AddEntry(HAll1D[1][8],"71X, Cosmic Reco","l");
  ...
  */
  ...
  HAll1D[0][0]->Draw("shist"); //SA pt, 53X
  HAll1D[0][4]->Draw("sameshist"); //RSA pt, 53X
  ...
  HAll1D[1][8]->Draw("sameshist"); //cosmic pt, 71X //best 3
