{
  ...
  */
  ...
  /*
  TFile f1("/home/alimena/histos/test_timing_zmumu_pt20_eta1.root");
  TFile f2("/home/alimena/histos/test_timing_zmumu_pt20_eta1_DT8.root");
  TFile f3("/home/alimena/histos/test_timing_zmumu_pt20_eta1_DTChambers2.root");
  TFile f4("/home/alimena/histos/test_timing_zmumu_pt20_eta1_DT8_DTChambers2.root");
  */

  /*
  TFile f1("/home/alimena/histos/test_timing_allphi_cosmics_pt20_eta1.root");
  TFile f2("/home/alimena/histos/test_timing_allphi_cosmics_pt20_eta1_DT8.root");
  TFile f3("/home/alimena/histos/test_timing_allphi_cosmics_pt20_eta1_DTChambers2.root");
  TFile f4("/home/alimena/histos/test_timing_allphi_cosmics_pt20_eta1_DT8_DTChambers2.root");
  */
  
  
  TFile f1("/home/alimena/histos/test_timing_stop600_neutralino417_pt20_eta1.root");
  TFile f2("/home/alimena/histos/test_timing_stop600_neutralino417_pt20_eta1_DT8.root");
  TFile f3("/home/alimena/histos/test_timing_stop600_neutralino417_pt20_eta1_DTChambers2.root");
  TFile f4("/home/alimena/histos/test_timing_stop600_neutralino417_pt20_eta1_DT8_DTChambers2.root");
  

  /*
  TFile f1("/home/alimena/histos/test_timing_zmumu_pt20_eta1_LESSinvbetaerror1p5.root");
  TFile f2("/home/alimena/histos/test_timing_allphi_cosmics_pt20_eta1_LESSinvbetaerror1p5.root");
  TFile f3("/home/alimena/histos/test_timing_stop600_neutralino417_pt20_eta1_LESSinvbetaerror1p5.root");
  */
  ...
  int color[NumFiles] = {1,2,4,6};
  int style[NumFiles] = {1,2,3,4};
  int marker[NumFiles] = {20,21,22,23};
  char axistitles[200];
  ...
  for (int a=0; a<NumFiles; a++){
    ...
    HAll1D[a][13]->GetXaxis()->SetRangeUser(0,10);
  ...
  //char* LegFile[NumFiles] = {"Z#rightarrow#mu#mu Data, No extra cuts","Z#rightarrow#mu#mu Data, DT hits>8","Z#rightarrow#mu#mu Data, NChambers>1","Z#rightarrow#mu#mu Data, DT hits>8, NChambers>1"};
  //char* LegFile[NumFiles] = {"Cosmic All-Phi Data, No extra cuts","Cosmic All-Phi Data, DT hits>8","Cosmic All-Phi Data, NChambers>1","Cosmic All-Phi Data, DT hits>8, NChambers>1"};
  char* LegFile[NumFiles] = {"#tilde{t_{1}} 600 GeV, No extra cuts","#tilde{t_{1}} 600 GeV, DT hits>8","#tilde{t_{1}} 600 GeV, NChambers>1","#tilde{t_{1}} 600 GeV, DT hits>8, NChambers>1"};
  char LegEntry[100];
  ...
  //TPaveLabel *Leg2a = new TPaveLabel(.19,.92,.39,.99,"Z#rightarrow#mu#mu Data, No extra cuts","NDC");
  //TPaveLabel *Leg2a = new TPaveLabel(.19,.92,.39,.99,"All-Phi Cosmic Data, No extra cuts","NDC");
  TPaveLabel *Leg2a = new TPaveLabel(.19,.92,.39,.99,"#tilde{t_{1}} 600 GeV, No extra cuts","NDC");
  Leg2a->SetBorderSize(0);
  Leg2a->SetTextSize(0.7);
  Leg2a->SetFillColor(0);

  //TPaveLabel *Leg2b = new TPaveLabel(.19,.92,.39,.99,"Z#rightarrow#mu#mu Data, DT hits>8","NDC");
  //TPaveLabel *Leg2b = new TPaveLabel(.19,.92,.39,.99,"All-Phi Cosmic Data, DT hits>8","NDC");
  TPaveLabel *Leg2b = new TPaveLabel(.19,.92,.39,.99,"#tilde{t_{1}} 600 GeV, DT hits>8","NDC");
  Leg2b->SetBorderSize(0);
  Leg2b->SetTextSize(0.7);
  Leg2b->SetFillColor(0);

  //TPaveLabel *Leg2c = new TPaveLabel(.19,.92,.39,.99,"Z#rightarrow#mu#mu Data, NChambers>1","NDC");
  //TPaveLabel *Leg2c = new TPaveLabel(.19,.92,.39,.99,"All-Phi Cosmic Data, NChambers>1","NDC");
  TPaveLabel *Leg2c = new TPaveLabel(.19,.92,.39,.99,"#tilde{t_{1}} 600 GeV, NChambers>1","NDC");
  Leg2c->SetBorderSize(0);
  Leg2c->SetTextSize(0.7);
  Leg2c->SetFillColor(0);

  //TPaveLabel *Leg2d = new TPaveLabel(.19,.92,.39,.99,"Z#rightarrow#mu#mu Data, DT hits>8, NChambers>1","NDC");
  //TPaveLabel *Leg2d = new TPaveLabel(.19,.92,.39,.99,"All-Phi Cosmic Data, DT hits>8, NChambers>1","NDC");
  TPaveLabel *Leg2d = new TPaveLabel(.19,.92,.39,.99,"#tilde{t_{1}} 600 GeV, DT hits>8, NChambers>1","NDC");
  ...
  for (int a=0; a<NumFiles; a++){
    for(int i=0; i<Num1DHists; i++){
      ...
      //else if(i==9) HAll1D[a][i]->GetYaxis()->SetRangeUser(0,100);
  ...
  for(int i=0; i<Num1DHists; i++){
    ...
    //sprintf(canvasesEPS,"../plots/timing/DT/compareCuts/zmumu/%s.eps",plot1D[i]);
    //sprintf(canvasesEPS,"../plots/timing/DT/compareCuts/cosmics/%s.eps",plot1D[i]);
    sprintf(canvasesEPS,"../plots/timing/DT/compareCuts/signal/%s.eps",plot1D[i]);
  ...
  for(int i=0; i<Num2DHists; i++){
    ...
    Leg2a->Draw();
    text1->Draw();
    //sprintf(canvasesEPS2D,"../plots/timing/DT/compareCuts/zmumu/%sNoAdditionalCuts.eps",plot2D[i]);
    //sprintf(canvasesEPS2D,"../plots/timing/DT/compareCuts/cosmics/%sNoAdditionalCuts.eps",plot2D[i]);
    sprintf(canvasesEPS2D,"../plots/timing/DT/compareCuts/signal/%sNoAdditionalCuts.eps",plot2D[i]);
  ...
  for(int i=Num2DHists; i<2*Num2DHists; i++){
    ...
    Leg2b->Draw();
    text1->Draw();
    //sprintf(canvasesEPS2D,"../plots/timing/DT/compareCuts/zmumu/%sDT8.eps",plot2D[i-Num2DHists]);
    //sprintf(canvasesEPS2D,"../plots/timing/DT/compareCuts/cosmics/%sDT8.eps",plot2D[i-Num2DHists]);
    sprintf(canvasesEPS2D,"../plots/timing/DT/compareCuts/signal/%sDT8.eps",plot2D[i-Num2DHists]);
    if (save_plots) canvases2D[i]->SaveAs(canvasesEPS2D);
  }
  for(int i=2*Num2DHists; i<3*Num2DHists; i++){
    ...
    Leg2c->Draw();
    text1->Draw();
    //sprintf(canvasesEPS2D,"../plots/timing/DT/compareCuts/zmumu/%sDtChambers2.eps",plot2D[i-2*Num2DHists]);
    //sprintf(canvasesEPS2D,"../plots/timing/DT/compareCuts/cosmics/%sDtChambers2.eps",plot2D[i-2*Num2DHists]);
    sprintf(canvasesEPS2D,"../plots/timing/DT/compareCuts/signal/%sDtChambers2.eps",plot2D[i-2*Num2DHists]);
    if (save_plots) canvases2D[i]->SaveAs(canvasesEPS2D);
  }
  for(int i=3*Num2DHists; i<4*Num2DHists; i++){
    ...
    Leg2d->Draw();
    text1->Draw();
    //sprintf(canvasesEPS2D,"../plots/timing/DT/compareCuts/zmumu/%sDT8_DtChambers2.eps",plot2D[i-3*Num2DHists]);
    //sprintf(canvasesEPS2D,"../plots/timing/DT/compareCuts/cosmics/%sDT8_DtChambers2.eps",plot2D[i-3*Num2DHists]);
    sprintf(canvasesEPS2D,"../plots/timing/DT/compareCuts/signal/%sDT8_DtChambers2.eps",plot2D[i-3*Num2DHists]);
    if (save_plots) canvases2D[i]->SaveAs(canvasesEPS2D);
  }
  /*
  for(int i=2*Num2DHists; i<3*Num2DHists; i++){
