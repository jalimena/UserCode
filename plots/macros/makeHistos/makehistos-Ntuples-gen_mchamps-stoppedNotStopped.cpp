{
  ...
  TFile f1 ("/home/alimena/histos/mchamp1000_reducedNtuples_724/wBxCut_woCavCut_woGenMuCut_woSACut_woGenMuMatchedCut_woTriggerCut_woPtCut_woChaCut_woEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut__woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  ...
  char* plot1DStopped[Num1DHists] = {
    "stopped_mcTauPrimeP_", //0
    "stopped_mcTauPrimePt_", //1
    "stopped_mcTauPrimeBeta_" //2
  };
  char* plot1DNotStopped[Num1DHists] = {
    "notStopped_mcTauPrimeP_", //0 
    "notStopped_mcTauPrimePt_", //1 
    "notStopped_mcTauPrimeBeta_" //2                
  };
  ...
  */
  ...
  //Leg1 = new TLegend(0.18,0.65,0.50,0.80,"100 GeV mchamps:");
  //Leg1 = new TLegend(0.18,0.65,0.50,0.80,"500 GeV mchamps:");
  Leg1 = new TLegend(0.18,0.65,0.50,0.80,"1000 GeV mchamps:");
  for (int a=0; a<NumFiles; a++){
  ...
  char LegEntry[100];
  //Leg2 = new TLegend(0.35,0.65,0.60,0.80,"100 GeV mchamps:");
  //Leg2 = new TLegend(0.35,0.65,0.60,0.80,"500 GeV mchamps:");
  Leg2 = new TLegend(0.34,0.65,0.60,0.80,"1000 GeV mchamps:");
