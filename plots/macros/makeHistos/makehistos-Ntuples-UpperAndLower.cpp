{
  ...
  //TFile f1 ("/home/alimena/histos/Zmumu_Run2012A_723patch1/wBxCut_wCavCut_woGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_wPtCut_wChaCut_woEtaCut_woUpperCut_wRpcCut_woDisStCut_woRpcBxCut__wDtHitsCut_wCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  //TFile f1 ("/home/alimena/histos/cosmicMC_Plus125_take2_updatedSim/wBxCut_wCavCut_woGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_wPtCut_wChaCut_woEtaCut_woUpperCut_wRpcCut_woDisStCut_woRpcBxCut__wDtHitsCut_wCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  //TFile f1 ("/home/alimena/histos/cosmics_allphi_NoBPTX_Run2012D_723patch1/wBxCut_wCavCut_woGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_wPtCut_wChaCut_woEtaCut_woUpperCut_wRpcCut_woDisStCut_woRpcBxCut__wDtHitsCut_wCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  //TFile f1 ("/home/alimena/histos/NoBPTX_Run2012C_ControlTriggers_723patch1/wBxCut_wCavCut_woGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_wPtCut_wChaCut_woEtaCut_woUpperCut_wRpcCut_woDisStCut_woRpcBxCut__wDtHitsCut_wCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");

  //final selection
  //TFile f1 ("/home/alimena/histos/mchamp500_separateEvents_725_updatedSim_fixedMatching/wBxCut_wCavCut_woGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_wPtCut_wChaCut_woEtaCut_wUpperCut_wRpcCut_woDisStCut_wRpcBxCut__wDtHitsCut_wCscHitsCut_woDtInvBetaCut_wTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  //TFile f1 ("/home/alimena/histos/Zmumu_Run2012A_723patch1/wBxCut_wCavCut_woGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_wPtCut_wChaCut_woEtaCut_wUpperCut_wRpcCut_woDisStCut_wRpcBxCut__wDtHitsCut_wCscHitsCut_woDtInvBetaCut_wTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  //TFile f1 ("/home/alimena/histos/cosmicMC_Plus125_take2_updatedSim/wBxCut_wCavCut_woGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_wPtCut_wChaCut_woEtaCut_wUpperCut_wRpcCut_woDisStCut_wRpcBxCut__wDtHitsCut_wCscHitsCut_woDtInvBetaCut_wTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  //TFile f1 ("/home/alimena/histos/NoBPTX_Run2012D_cosmics_allphi_723patch1/wBxCut_wCavCut_woGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_wPtCut_wChaCut_woEtaCut_wUpperCut_wRpcCut_woDisStCut_wRpcBxCut__wDtHitsCut_wCscHitsCut_woDtInvBetaCut_wTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");

  //cout<<"Loaded file: "<<file<<endl;

  //info for each 1D plot
  const int Num1DHists = 28;
  char* plot1DBoth[Num1DHists] = {
    ...
    "Both_muDisplacedStandAloneTrackDtTofTimeAtIpOutIn_",//19
    "Both_muDisplacedStandAloneTrackDtTofTimeAtIpInOutErr_",//20
    "Both_muDisplacedStandAloneTrackDtTofTimeAtIpOutInErr_",//21
    "Both_muDisplacedStandAloneTrackDtTofDirection_",//22
    "Both_muDisplacedStandAloneTrackDtTofNDof_", //23
    "Both_muDisplacedStandAloneTrackNRpcDof_", //24
    "Both_muDisplacedStandAloneTrackDtTofFreeInverseBetaErr_", //25
    "Both_muDisplacedStandAloneTrackDtTofErrDiff_",//26
    "Both_muDisplacedStandAloneBxAverage_" //27
  };
  char* plot1DUpper[Num1DHists] = {
    "muDisplacedStandAlone_N_", //0
    "Upper_muDisplacedStandAlonePt_", //1
    "Upper_muDisplacedStandAloneEta_", //2
    "Upper_muDisplacedStandAlonePhi_", //3
    "Upper_muDisplacedStandAloneTrackCharge_", //4
    "Upper_muDisplacedStandAloneTrackNormalizedChi2_", //5
    "Upper_muDisplacedStandAloneTrackDxy_", //6
    "Upper_muDisplacedStandAloneTrackDz_", //7
    "Upper_muDisplacedStandAloneTrackNHitsMuon_", //8
    "Upper_muDisplacedStandAloneTrackNHitsCsc_", //9
    "Upper_muDisplacedStandAloneTrackNHitsDt_", //10
    "Upper_muDisplacedStandAloneTrackNHitsRpc_", //11
    "Upper_muDisplacedStandAloneTrackNStations_", //12
    "Upper_muDisplacedStandAloneTrackNChambersCsc_", //13
    "Upper_muDisplacedStandAloneTrackNChambersDt_", //14
    "Upper_muDisplacedStandAloneTrackNChambersRpc_", //15
    "Upper_muDisplacedStandAloneBxPattern_", //16
    "Upper_muDisplacedStandAloneTrackDtTofFreeInverseBeta_", //17
    "Upper_muDisplacedStandAloneTrackDtTofTimeAtIpInOut_",//18
    "Upper_muDisplacedStandAloneTrackDtTofTimeAtIpOutIn_",//18
    "Upper_muDisplacedStandAloneTrackDtTofTimeAtIpInOutErr_",//18
    "Upper_muDisplacedStandAloneTrackDtTofTimeAtIpOutInErr_",//18
    "Upper_muDisplacedStandAloneTrackDtTofDirection_",//19
    "Upper_muDisplacedStandAloneTrackDtTofNDof_", //20
    "Upper_muDisplacedStandAloneTrackNRpcDof_", //21
    "Upper_muDisplacedStandAloneTrackDtTofFreeInverseBetaErr_", //22
    "Upper_muDisplacedStandAloneTrackDtTofErrDiff_",//26
    "Upper_muDisplacedStandAloneBxAverage_" //27
  };
  char* plot1DLower[Num1DHists] = {
    "muDisplacedStandAlone_N_", //0
    "Lower_muDisplacedStandAlonePt_", //1
    "Lower_muDisplacedStandAloneEta_", //2
    "Lower_muDisplacedStandAlonePhi_", //3
    "Lower_muDisplacedStandAloneTrackCharge_", //4
    "Lower_muDisplacedStandAloneTrackNormalizedChi2_", //5
    "Lower_muDisplacedStandAloneTrackDxy_", //6
    "Lower_muDisplacedStandAloneTrackDz_", //7
    "Lower_muDisplacedStandAloneTrackNHitsMuon_", //8
    "Lower_muDisplacedStandAloneTrackNHitsCsc_", //9
    "Lower_muDisplacedStandAloneTrackNHitsDt_", //10
    "Lower_muDisplacedStandAloneTrackNHitsRpc_", //11
    "Lower_muDisplacedStandAloneTrackNStations_", //12
    "Lower_muDisplacedStandAloneTrackNChambersCsc_", //13
    "Lower_muDisplacedStandAloneTrackNChambersDt_", //14
    "Lower_muDisplacedStandAloneTrackNChambersRpc_", //15
    "Lower_muDisplacedStandAloneBxPattern_", //16
    "Lower_muDisplacedStandAloneTrackDtTofFreeInverseBeta_", //17
    "Lower_muDisplacedStandAloneTrackDtTofTimeAtIpInOut_",//18
    "Lower_muDisplacedStandAloneTrackDtTofTimeAtIpOutIn_",//18
    "Lower_muDisplacedStandAloneTrackDtTofTimeAtIpInOutErr_",//18
    "Lower_muDisplacedStandAloneTrackDtTofTimeAtIpOutInErr_",//18
    "Lower_muDisplacedStandAloneTrackDtTofDirection_",//19
    "Lower_muDisplacedStandAloneTrackDtTofNDof_", //20
    "Lower_muDisplacedStandAloneTrackNRpcDof_", //21
    "Lower_muDisplacedStandAloneTrackDtTofFreeInverseBetaErr_", //22
    "Lower_muDisplacedStandAloneTrackDtTofErrDiff_",//26
    "Lower_muDisplacedStandAloneBxAverage_" //27
  };
  ...
  char* xtitle1D[Num1DHists] = {
    ...
    "DSA Track TimeOutIn [ns]",
    "DSA Track TimeInOut Error [ns]",
    "DSA Track TimeOutIn Error [ns]",
    "DSA Track TOF Direction",
    "DSA Track TOF nDOF",
    "DSA Track RPC BX nDOF",
    "DSA Track #beta^{-1}_{Free} Error",
    "DSA Track Error(TimeInOut)-Error(TimeOutIn)",
    "DSA Track Average RPC BX"
  };
  ...
  */
  ...
  for (int i=0; i<Num1DHists; i++){
    ...
    sprintf(Ctitle1D,"%s",plot1DBoth[i]);
    canvases1D[i] = new TCanvas(Cname1D,Ctitle1D,10,10,575,500);
    if (i!=0 && i!=4 && i!=16 && i!=27) canvases1D[i]->SetLogy();
    if(i==16){
  ...
  */
  ...
  char oldH1DnameBoth[100], oldH1DnameUpper[100], oldH1DnameLower[100];
  for(int i=0; i<Num1DHists; i++){
    sprintf(oldH1DnameBoth,"%shist",plot1DBoth[i]);
    sprintf(oldH1DnameUpper,"%shist",plot1DUpper[i]);
    sprintf(oldH1DnameLower,"%shist",plot1DLower[i]);
    HAll1D[0][i] = (TH1D*) f1.Get(oldH1DnameBoth);
    HAll1D[1][i] = (TH1D*) f1.Get(oldH1DnameUpper);
    HAll1D[2][i] = (TH1D*) f1.Get(oldH1DnameLower);
  ...
  */
  for (int a=0; a<NumFiles; a++){
    ...
    HAll1D[a][20]->GetXaxis()->SetRangeUser(0,20);
    HAll1D[a][21]->GetXaxis()->SetRangeUser(0,20);
    HAll1D[a][23]->GetXaxis()->SetRangeUser(0,40);
    HAll1D[a][25]->GetXaxis()->SetRangeUser(0,30);
    HAll1D[a][26]->GetXaxis()->SetRangeUser(-10,10);
    HAll1D[a][27]->GetXaxis()->SetRangeUser(-3,3);
    /*
  ...
  char* LegFile[NumFiles] = {"Both Muons","Upper Muon","Lower Muon"};

  char LegEntry[100];
  //Leg1 = new TLegend(0.68,0.75,0.94,0.90);
  //Leg1 = new TLegend(0.68,0.75,0.94,0.90,"500 GeV mchamps:");
  //Leg1 = new TLegend(0.68,0.75,0.94,0.90,"Z#rightarrow#mu#mu Data:");
  //Leg1 = new TLegend(0.68,0.75,0.94,0.90,"Cosmic MC:");
  Leg1 = new TLegend(0.68,0.75,0.94,0.90,"Cosmic Data:");
  //Leg1 = new TLegend(0.68,0.75,0.94,0.90,"Control Trigger Data:");
  for (int a=0; a<NumFiles; a++){
  ...
  //Leg2 = new TLegend(0.58,0.75,0.84,0.90,"500 GeV mchamps:");
  //Leg2 = new TLegend(0.58,0.75,0.84,0.90,"Z#rightarrow#mu#mu Data:");
  //Leg2 = new TLegend(0.58,0.75,0.84,0.90,"Cosmic MC:");
  Leg2 = new TLegend(0.58,0.75,0.84,0.90,"Cosmic Data:");
  //Leg2 = new TLegend(0.58,0.75,0.84,0.90,"Control Trigger Data:");
  for (int a=0; a<NumFiles; a++){
    sprintf(LegEntry,"%s",LegFile[a]);
    Leg2->AddEntry(HAll1D[a][1],LegEntry,"l");
  }
  ...
  */
  ...
  for (int a=0; a<NumFiles; a++){
    ...
    */
    HAll1D[a][16]->GetYaxis()->SetRangeUser(0,6000); //500 GeV mchamps
    //HAll1D[a][16]->GetYaxis()->SetRangeUser(0,18000); //zmumu data
    //HAll1D[a][16]->GetYaxis()->SetRangeUser(0,1000); //cosmic MC
    //HAll1D[a][16]->GetYaxis()->SetRangeUser(0,11000); //cosmic data

    //HAll1D[a][18]->GetYaxis()->SetRangeUser(.1,4000); //cosmic MC
    //HAll1D[a][18]->GetYaxis()->SetRangeUser(.1,100000); //cosmic data

    //HAll1D[a][19]->GetYaxis()->SetRangeUser(.1,4000); //cosmic MC
    //HAll1D[a][19]->GetYaxis()->SetRangeUser(.1,100000); //cosmic data

    HAll1D[a][20]->GetYaxis()->SetRangeUser(.1,4000); //500 GeV mchamps
    //HAll1D[a][20]->GetYaxis()->SetRangeUser(.1,10000); //zmumu data
    //HAll1D[a][20]->GetYaxis()->SetRangeUser(.1,1000); //cosmic MC
    //HAll1D[a][20]->GetYaxis()->SetRangeUser(.1,10000); //cosmic data

    HAll1D[a][21]->GetYaxis()->SetRangeUser(.1,4000); //500 GeV mchamps
    //HAll1D[a][21]->GetYaxis()->SetRangeUser(.1,10000); //zmumu data
    //HAll1D[a][21]->GetYaxis()->SetRangeUser(.1,1000); //cosmic MC
    //HAll1D[a][21]->GetYaxis()->SetRangeUser(.1,10000); //cosmic data

    HAll1D[a][22]->GetYaxis()->SetRangeUser(1,600000); //500 GeV mchamps
    //HAll1D[a][22]->GetYaxis()->SetRangeUser(1,600000); //zmumu data
    //HAll1D[a][22]->GetYaxis()->SetRangeUser(1,60000); //cosmic MC
    //HAll1D[a][22]->GetYaxis()->SetRangeUser(1,600000); //cosmic data
  }
