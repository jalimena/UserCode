{
  ...
  //TFile f1 ("/home/alimena/histos/gluino900_neutralino794_reducedNtuples_724/wBxCut_woCavCut_woGenMuCut_woSACut_woGenMuMatchedCut_woTriggerCut_woPtCut_woChaCut_woEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut__woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  TFile f1 ("/home/alimena/histos/gluino1500_neutralino1396_reducedNtuples_724/wBxCut_woCavCut_woGenMuCut_woSACut_woGenMuMatchedCut_woTriggerCut_woPtCut_woChaCut_woEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut__woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  ...
  char* plot1DStopped[Num1DHists] = {
    "stopped_mcGluinoP_", //0
    "stopped_mcGluinoPt_", //1
    "stopped_mcGluinoBeta_" //2
  };
  char* plot1DNotStopped[Num1DHists] = {
    "notStopped_mcGluinoP_", //0 
    "notStopped_mcGluinoPt_", //1 
    "notStopped_mcGluinoBeta_" //2                
  };
  ...
  */
  ...
  //Leg1 = new TLegend(0.18,0.65,0.50,0.80,"300 GeV gluinos:");
  //Leg1 = new TLegend(0.18,0.65,0.50,0.80,"900 GeV gluinos:");
  Leg1 = new TLegend(0.18,0.65,0.50,0.80,"1500 GeV gluinos:");
  for (int a=0; a<NumFiles; a++){
  ...
  char LegEntry[100];
  //Leg2 = new TLegend(0.35,0.65,0.60,0.80,"300 GeV gluinos:");
  //Leg2 = new TLegend(0.35,0.65,0.60,0.80,"900 GeV gluinos:");
  Leg2 = new TLegend(0.34,0.65,0.60,0.80,"1500 GeV gluinos:");
