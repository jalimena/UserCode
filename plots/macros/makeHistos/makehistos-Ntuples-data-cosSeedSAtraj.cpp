{
  ...
  TFile f1 ("/home/alimena/histos/NoBPTX_Run2012D_72X/wBxCut_wCavCut_wGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_woPtCut_woChaCut_woEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut_woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root"); //no cuts, 71X, cosmic seed + SA reco

  TFile f2 ("/home/alimena/histos/NoBPTX_Run2012D_72X/wBxCut_wCavCut_wGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_woPtCut_wChaCut_wEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut_woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich_loose.root"); //loose dt, 71X, cosmic seed + SA reco
  TFile f3 ("/home/alimena/histos/NoBPTX_Run2012D_72X/wBxCut_wCavCut_wGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_woPtCut_wChaCut_wEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut_woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich_medium.root"); //medium dt, 71X, cosmic seed + SA reco
  TFile f4 ("/home/alimena/histos/NoBPTX_Run2012D_72X/wBxCut_wCavCut_wGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_woPtCut_wChaCut_wEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut_woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich_tight.root"); //tight dt, 71X, cosmic seed + SA reco
  ...
  */
  ...
  for (int a=0; a<NumFiles; a++){
    ...
    HAll1D[a][0]->GetXaxis()->SetRangeUser(0,200);
    HAll1D[a][4]->GetXaxis()->SetRangeUser(0,200);
    HAll1D[a][8]->GetXaxis()->SetRangeUser(0,200);
  ...
  char* LegFile[NumFiles] = {"72X, cosSeed, SA traj, no cuts","72X, cosSeed, SA traj, loose DT cuts","72X, cosSeed, SA traj, medium DT cuts","72X, cosSeed, SA traj, tight DT cuts"};
  char LegEntry[100];
