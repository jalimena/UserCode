{
  ...
  //TFile f1("/home/alimena/histos/NoBPTX_Run2012D_cosmics_allphi_723patch1/wBxCut_wCavCut_wGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_wPtCut_wChaCut_woEtaCut_woUpperCut_wRpcCut_woDisStCut_woRpcBxCut__wDtHitsCut_wCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  //TFile f1("/home/alimena/histos/SingleMu_Run2012A_723patch1/wBxCut_wCavCut_wGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_wPtCut_wChaCut_woEtaCut_woUpperCut_wRpcCut_woDisStCut_woRpcBxCut__wDtHitsCut_wCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  //TFile f1("/home/alimena/histos/NoBPTX_Run2012B_period1_723patch1/wBxCut_wCavCut_wGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_wPtCut_wChaCut_woEtaCut_woUpperCut_wRpcCut_woDisStCut_woRpcBxCut__wDtHitsCut_wCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  //TFile f1("/home/alimena/histos/NoBPTX_Run2012B_period2_723patch1/wBxCut_wCavCut_wGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_wPtCut_wChaCut_woEtaCut_woUpperCut_wRpcCut_woDisStCut_woRpcBxCut__wDtHitsCut_wCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  //TFile f1("/home/alimena/histos/NoBPTX_Run2012C_723patch1/wBxCut_wCavCut_wGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_wPtCut_wChaCut_woEtaCut_woUpperCut_wRpcCut_woDisStCut_woRpcBxCut__wDtHitsCut_wCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  //TFile f1("/home/alimena/histos/NoBPTX_Run2012D_723patch1/wBxCut_wCavCut_wGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_wPtCut_wChaCut_woEtaCut_woUpperCut_wRpcCut_woDisStCut_woRpcBxCut__wDtHitsCut_wCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  TFile f1("/home/alimena/histos/AveTimingHistos/histos_Run2012AtoD.root");
  //TFile f1("/home/alimena/histos/AveTimingHistos/histos_upper_Run2012AtoD.root");
  //TFile f1("/home/alimena/histos/AveTimingHistos/histos_lower_Run2012AtoD.root");
  ...
  */
  ...
  char* plot2D[Num2DHists] = {
    "runNumber_muDisplacedStandAlonePt_",//0
    "runNumber_muDisplacedStandAloneDtTofFreeInverseBeta_",//1
    "runNumber_muDisplacedStandAloneDtTofInverseBeta_",//2
    "runNumber_muDisplacedStandAlonePhi_",//3
    "runNumber_muDisplacedStandAloneN_",//4
    "Upper_runNumber_muDisplacedStandAloneDtTofFreeInverseBeta_",//5 
    "Upper_runNumber_muDisplacedStandAloneDtTofInverseBeta_",//6
    "Upper_runNumber_muDisplacedStandAlonePhi_",//7
    "Upper_runNumber_muDisplacedStandAloneN_",//8
    "Lower_runNumber_muDisplacedStandAloneDtTofFreeInverseBeta_",//9
    "Lower_runNumber_muDisplacedStandAloneDtTofInverseBeta_",//10
    "Lower_runNumber_muDisplacedStandAlonePhi_",//11
    "Lower_runNumber_muDisplacedStandAloneN_"//12
  };
  char* xtitle2D = "Run Number";
  char* ytitle2D[Num2DHists] = {"Displaced SA p_{T} [GeV]","Displaced SA DT Free #beta^{-1}","Displaced SA DT #beta^{-1}","Displaced SA #phi","Number of Preselected DSAs","Displaced SA Upper DT Free #beta^{-1}","Displaced SA Upper DT #beta^{-1}","Displaced SA Upper #phi","Number of Upper Preselected DSAs","Displaced SA Lower DT Free #beta^{-1}","Displaced SA Lower DT #beta^{-1}","Displaced SA Lower #phi","Number of Lower Preselected DSAs"};
  ...
  */
  ...
  for(int a=0; a<NumFiles; a++){
    ...
    */
    for(int i=0; i<Num2DHists; i++){
      cout<<"i is: "<<i<<endl;
      sprintf(axistitles,";%s;%s",xtitle2D,ytitle2D[i]);
      cout<<"printed axis titles"<<endl;
      ...
      cout<<"xtitle2D[i] is: "<<xtitle2D<<endl;
    }
  }
  ...
  */
  ...
  for (int a=0; a<NumFiles; a++){
    for(int i=0; i<Num2DHists; i++){
      //HAll2D[a][i]->GetXaxis()->SetRangeUser(190000,210000);
    }
  }
  ...
  */
  ...
  //TProfile* profile[NumFiles][Num2DHists];
  TH1* profile[NumFiles][Num2DHists];
  char oldprofilename[100];
  char praxistitles[200];
  for(int i=0; i<Num2DHists; i++){
    sprintf(oldprofilename,"%sprofile",plot2D[i]);
    //profile[0][i] = HAll2D[0][i]->ProfileX(oldprofilename);
    profile[0][i] = HAll2D[0][i]->FitSlicesX();
    sprintf(praxistitles,";%s;Average %s",xtitle2D,ytitle2D[i]);
    profile[0][i]->SetTitle(praxistitles);
  }

  TF1 *linfit1 = new TF1("linfit1","[0]*x+[1]",191000,209000);
  linfit1->SetLineColor(2); 
  //profile[0][0]->Fit("linfit1","R");
  //profile[0][2]->Fit("linfit1","R");

  TF1 *linfitBeta1 = new TF1("linfitBeta1","[0]*x+[1]",193800,196600);
  TF1 *linfitBeta2 = new TF1("linfitBeta2","[0]*x+[1]",198000,203750);
  TF1 *linfitBeta3 = new TF1("linfitBeta3","[0]*x+[1]",203770,208700);
  linfitBeta1->SetLineColor(2); 
  linfitBeta2->SetLineColor(2); 
  linfitBeta3->SetLineColor(2); 

  for(int i=1; i<Num2DHists; i++){
    //profile[0][i]->Fit("linfitBeta1","R");
    //profile[0][i]->Fit("linfitBeta2","R+","sames");
    //profile[0][i]->Fit("linfitBeta3","R+","sames");
  }

  //profile[0][0]->Draw();
  //stats = (TPaveStats*)profile[0][0]->GetListOfFunctions()->FindObject("stats");  

  for(int i=0; i<Num2DHists; i++){
    canvases2D[i]->cd();
    //gPad->Update();
    //canvases2D[i]->Update();
    //stats[i] = (TPaveStats*)profile[i][i]->GetListOfFunctions()->FindObject("stats");
    //HAll2D[i][i]->Draw("colz");
    profile[0][i]->Draw();
    //Leg2a->Draw();
    text1->Draw();
    //stats->SetY1NDC(0.05);
