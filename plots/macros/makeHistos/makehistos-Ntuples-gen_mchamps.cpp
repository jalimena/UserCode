{
  ...
  char* plot1D[Num1DHists] = {
    ...
    "mcTauPrimePhi_", //7
    "mcTauPrimeBeta_", //8
    "stopped_mcTauPrimeP_", //9
    "stopped_mcTauPrimePt_", //10
    "stopped_mcTauPrimeEta_", //11
    "stopped_mcTauPrimePhi_", //12
    "stopped_mcTauPrimeBeta_", //13
    "notStopped_mcTauPrimeP_", //14 
    "notStopped_mcTauPrimePt_", //15 
    "notStopped_mcTauPrimeEta_", //16 
    "notStopped_mcTauPrimePhi_", //17 
    "notStopped_mcTauPrimeBeta_" //18                
  };

  char* xtitle1D[Num1DHists] = {
    "Number of Generated Mchamps",
    "Generator Mchamp p [GeV]",
    "Generator Mchamp p_{x} [GeV]",
    "Generator Mchamp p_{y} [GeV]",
    "Generator Mchamp p_{z} [GeV]",
    "Generator Mchamp p_{T} [GeV]",
    "Generator Mchamp #eta",
    "Generator Mchamp #phi",
    "Generator Mchamp #beta",
    "Generator Mchamp p [GeV]",
    "Generator Mchamp p_{T} [GeV]",
    "Generator Mchamp #eta",
    "Generator Mchamp #phi",
  ...
  */
  ...
  for(int a=0; a<NumFiles; a++){
    ...
    cout<<"There are "<<HAll1D[a][13]->GetEntries()<<" entries in the HAll1D["<<a<<"][13]"<<endl;
    ...
    HAll1D[a][14]->GetXaxis()->SetNdivisions(505);
    HAll1D[a][15]->GetXaxis()->SetNdivisions(505);
    for(int i=0; i<Num1DHists; i++){
  ...
  */
  for (int a=0; a<NumFiles; a++){
    ...
    HAll1D[a][14]->Rebin(10);
    HAll1D[a][15]->Rebin(10);
    /*
    ...
    */
    ...
    HAll1D[a][14]->GetXaxis()->SetRangeUser(0,2000);
    HAll1D[a][15]->GetXaxis()->SetRangeUser(0,2000);
    ...
    HAll1D[a][14]->GetXaxis()->SetRangeUser(0,3000);
    HAll1D[a][15]->GetXaxis()->SetRangeUser(0,3000);
    */
  }    
  ...
  */
  ...
  for (int a=0; a<NumFiles; a++){
    //linear 
    HAll1D[a][1]->GetYaxis()->SetRangeUser(0,14000);
    HAll1D[a][5]->GetYaxis()->SetRangeUser(0,14000);

    HAll1D[a][9]->GetYaxis()->SetRangeUser(0,14000);
    HAll1D[a][10]->GetYaxis()->SetRangeUser(0,14000);
    HAll1D[a][13]->GetYaxis()->SetRangeUser(0,10000);

    HAll1D[a][14]->GetYaxis()->SetRangeUser(0,14000);
    HAll1D[a][15]->GetYaxis()->SetRangeUser(0,14000);
    ...
    HAll1D[a][15]->GetYaxis()->SetRangeUser(1,5000000);
    HAll1D[a][16]->GetYaxis()->SetRangeUser(1,5000000);
    HAll1D[a][17]->GetYaxis()->SetRangeUser(1,5000000);
    HAll1D[a][18]->GetYaxis()->SetRangeUser(1,5000000);
    */
  }
