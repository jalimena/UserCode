{
  ...
  TFile f2 ("/home/alimena/histos/gluino900_neutralino794_reducedNtuples_724/wBxCut_woCavCut_woGenMuCut_woSACut_woGenMuMatchedCut_woTriggerCut_woPtCut_woChaCut_woEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut__woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  TFile f3 ("/home/alimena/histos/gluino1500_neutralino1396_reducedNtuples_724/wBxCut_woCavCut_woGenMuCut_woSACut_woGenMuMatchedCut_woTriggerCut_woPtCut_woChaCut_woEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut__woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  ...
  char* plot1D[Num1DHists] = {
    ...
    "mcGluinoPhi_", //7
    "mcGluinoBeta_", //8
    "stopped_mcGluinoP_", //9
    "stopped_mcGluinoPt_", //10
    "stopped_mcGluinoBeta_", //11
    "notStopped_mcGluinoP_", //12 
    "notStopped_mcGluinoPt_", //13 
    "notStopped_mcGluinoBeta_" //14                
  };

  char* xtitle1D[Num1DHists] = {
    "Number of Generated Gluinos",
    "Generator Gluino p [GeV]",
    "Generator Gluino p_{x} [GeV]",
    "Generator Gluino p_{y} [GeV]",
    "Generator Gluino p_{z} [GeV]",
    "Generator Gluino p_{T} [GeV]",
    "Generator Gluino #eta",
    "Generator Gluino #phi",
    "Generator Gluino #beta",
    "Generator Gluino p [GeV]",
    "Generator Gluino p_{T} [GeV]",
    "Generator Gluino #beta",
    "Generator Gluino p [GeV]",
  ...
  */
  ...
  char* LegFile[NumFiles] = {"300 GeV gluinos","900 GeV gluinos","1500 GeV gluinos"};
  ...
  */
  ...
  for (int a=0; a<NumFiles; a++){
    ...
    HAll1D[a][8]->GetYaxis()->SetRangeUser(0,15000);

    HAll1D[a][9]->GetYaxis()->SetRangeUser(0,4500);
    HAll1D[a][10]->GetYaxis()->SetRangeUser(0,4500);
    HAll1D[a][11]->GetYaxis()->SetRangeUser(0,6000);

    HAll1D[a][12]->GetYaxis()->SetRangeUser(0,12000);
    HAll1D[a][13]->GetYaxis()->SetRangeUser(0,12000);
    HAll1D[a][14]->GetYaxis()->SetRangeUser(0,15000);
