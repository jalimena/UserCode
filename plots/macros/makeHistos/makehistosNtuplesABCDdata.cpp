//REQUIRES ROOT6 TO WORK PROPERLY
#include "tdrstyle.C"
#include "CMS_lumi.C"
...
void makehistosNtuplesABCDdata(){
  ...
  TFile f1 ("/home/alimena/histos/ABCDtree_1DSAdata_Run2012BCD_pRpcBx/wBxCut_wCavCut_woGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_wPtCut_wChaCut_woEtaCut_wUpperCut_wRpcCut_woDisStCut_woRpcBxCut__wDtHitsCut_wCscHitsCut_wDtInvBetaCut_wTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  TFile f2 ("/home/alimena/histos/mchamp500_separateEvents_725_updatedSim_fixedMatching/wBxCut_wCavCut_woGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_wPtCut_wChaCut_woEtaCut_wUpperCut_wRpcCut_woDisStCut_woRpcBxCut__wDtHitsCut_wCscHitsCut_wDtInvBetaCut_wTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");


  /*
  TFile f1 ("/home/alimena/histos/ABCDtree_2DSAdata_Run2012BCD_pRpcBx/wBxCut_wCavCut_woGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_wPtCut_wChaCut_woEtaCut_woUpperCut_wRpcCut_woDisStCut_woRpcBxCut__wDtHitsCut_wCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  ...
  */
  ...
  //TFile f1 ("/home/alimena/histos/cosmics_allphi_NoBPTX_Run2012D_723patch1/wBxCut_wCavCut_woGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_wPtCut_wChaCut_woEtaCut_wUpperCut_wRpcCut_woDisStCut_woRpcBxCut__wDtHitsCut_wCscHitsCut_woDtInvBetaCut_wTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  //TFile f2 ("/home/alimena/histos/mchamp500_ABCDtree_2DSA_723patch1/wBxCut_wCavCut_woGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_wPtCut_wChaCut_woEtaCut_wUpperCut_wRpcCut_woDisStCut_wRpcBxCut__wDtHitsCut_wCscHitsCut_wDtInvBetaCut_wTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");

  //TFile f1 ("/home/alimena/histos/cosmicMC_Plus125_take2_updatedSim/wBxCut_wCavCut_woGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_wPtCut_wChaCut_woEtaCut_wUpperCut_wRpcCut_woDisStCut_woRpcBxCut__wDtHitsCut_wCscHitsCut_woDtInvBetaCut_wTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  //TFile f2 ("/home/alimena/histos/mchamp500_ABCDtree_2DSA_723patch1/wBxCut_wCavCut_woGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_wPtCut_wChaCut_woEtaCut_wUpperCut_wRpcCut_woDisStCut_wRpcBxCut__wDtHitsCut_wCscHitsCut_wDtInvBetaCut_wTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  ...
  char* plot1D[Num1DHists] = {
    ...
    */
    ...
    "regionD_muDisplacedStandAloneBxPattern_", //1
    "regionB_muDisplacedStandAloneP_", //2
    "regionC_muDisplacedStandAloneTrackBxPattern_" //3
  };
  ...
  char* xtitle1D[Num1DHists] = {
    ...
    */
    ...
    "DSA Track p [GeV]", //0
    "DSA Track RPC BX Pattern", //1
    "DSA Track p [GeV]", //2
    "DSA Track RPC BX Pattern" //3
  };
  ...
  */
  //char* plot2D[Num2DHists] = {"Lower_muDisplacedStandAloneP_Lower_muDisplacedStandAloneBxPattern_"};
  char* plot2D[Num2DHists] = {"muDisplacedStandAloneP_BxPattern_"};
  //char* plot2D[Num2DHists] = {"Upper_muDisplacedStandAloneP_Upper_muDisplacedStandAloneTrackDtTofFreeInverseBeta_"};
  //char* plot2D[Num2DHists] = {"muDisplacedStandAloneP_DtTofFreeInverseBeta_"};
  char* xtitle2D[Num2DHists] = {"DSA Track p [GeV]"};
  char* ytitle2D[Num2DHists] = {"DSA Track RPC BX Pattern"};
  //char* ytitle2D[Num2DHists] = {"DSA Track #beta^{-1}_{Free}"};
  ...
  for (int i=0; i<Num1DHists; i++){
    ...
    if(i==1 || i==3){
      canvases1D[i]->SetBottomMargin(0.15);
      canvases1D[i]->SetRightMargin(0.10);
    }
  }
  ...
  for (int i=0; i<Num2DHists; i++){
    ...
    canvases2D[i]->SetLeftMargin(0.21);
  ...
  */
  ...
  for(int a=0; a<NumFiles; a++){
    ...
    for(int i=0; i<Num1DHists; i++){
      ...
      if(i==1 || i==3) HAll1D[a][i]->SetTitleOffset(1.7,"X");
      //cout<<"h1_style"<<endl;
    ...
    for(int i=0; i<Num2DHists; i++){
      ...
      HAll2D[a][i]->SetTitleOffset(3.3,"Y");
  ...
  */
  ...
  //char* LegFile[NumFiles+1] = {"Data","Background"};
  ...
  */
  ...
  //TLegend* Leg2 = new TLegend(0.19,0.67,0.42,0.85);
  TLegend* Leg2 = new TLegend(0.62,0.75,0.85,0.93);
  sprintf(LegEntry,"%s",LegFile[0]);
  ...
  */
  ...
  //2DSA, with charge, without delta timeinout
  //Double_t B_scale = 1.0*18/227;//events in B scaled by C/A
  //Double_t C_scale = 1.0*449/227;//events in C scaled by B/A

  //2DSA, p vs RPC BX pattern
  //Double_t B_scale = 1.0*27/364;//events in B scaled by C/A
  //Double_t C_scale = 1.0*119/364;//events in C scaled by B/A

  //1DSA, p vs RPC BX pattern
  Double_t B_scale = 1.0*1813/35600;//events in B scaled by C/A
  Double_t C_scale = 1.0*6722/35600;//events in C scaled by B/A

  //2DSA, without charge, with delta timeinout
  //Double_t B_scale = 1.0*22/227;//events in B scaled by C/A
  //Double_t C_scale = 1.0*56/227;//events in C scaled by B/A

  //1DSA
  //Double_t B_scale = 1.0*4392/137207;//events in B scaled by C/A
  //Double_t C_scale = 1.0*27411/137207;//events in C scaled by B/A
  ...
  for (int a=0; a<NumFiles; a++){
    ...
    HAll1D[a][1]->GetYaxis()->SetRangeUser(.0001,10000);
    HAll1D[a][3]->GetYaxis()->SetRangeUser(.0001,10000);

    /*
    //1DSA
    HAll1D[a][0]->GetYaxis()->SetRangeUser(.0001,3000);
    HAll1D[a][2]->GetYaxis()->SetRangeUser(.0001,3000);
...
*/
  ...
  const int nbins = HAll2D[0][0]->GetNbinsY();
  string BxPatternLabel[] = {"BXs==0","BXs>0, constant","BXs>=0, increasing","BXs>=0, decreasing","BXs>=0, strange","BXs<0, constant","BXs<=0, increasing","BXs<=0, decreasing","BXs<=0, strang\
e"};
  for (int x=0; x<nbins; x++) {
    HAll2D[0][0]->GetYaxis()->SetBinLabel(x+1,BxPatternLabel[x].c_str());
    HAll2D[1][0]->GetYaxis()->SetBinLabel(x+1,BxPatternLabel[x].c_str());
  }

  TH1D* hnew_p = new TH1D("hnew_p","hnew_p",50,0,1000);
  TH1D* hnew_inversebeta = new TH1D("hnew_inversebeta","hnew_inversebeta",1000,-50,50);
  TH1D* hnew_rpcbxpattern = new TH1D("hnew_rpcbxpattern","hnew_rpcbxpattern",9,0,9);
  hnew_p->SetBinErrorOption(TH1::kPoisson);
  hnew_inversebeta->SetBinErrorOption(TH1::kPoisson);
  hnew_rpcbxpattern->SetBinErrorOption(TH1::kPoisson);
  hnew_p->SetMarkerStyle(20);
  hnew_inversebeta->SetMarkerStyle(20);
  hnew_rpcbxpattern->SetMarkerStyle(20);
  hnew_p->SetMarkerSize(1.3);
  hnew_inversebeta->SetMarkerSize(1.3);
  hnew_rpcbxpattern->SetMarkerSize(1.3);
  hnew_p->SetMarkerColor(1);
  hnew_inversebeta->SetMarkerColor(1);
  hnew_rpcbxpattern->SetMarkerColor(1);
  ...
  for(int i=1; i<=HAll1D[0][1]->GetNbinsX(); i++){
    ...
    if(HAll1D[0][1]->GetBinContent(i)==0 && HAll1D[0][3]->GetBinContent(i)==0) hnew_rpcbxpattern->SetBinContent(i,100000000);
    else hnew_rpcbxpattern->SetBinContent(i,HAll1D[0][1]->GetBinContent(i));
  ...
  //if (save_plots) canvases1D[0]->SaveAs("p.png");
  if (save_plots) canvases1D[0]->SaveAs("p_1DSAdata.png");
  ...
  hnew_rpcbxpattern->Draw("pe0same");
  Leg2->Draw();
  CMS_lumi( canvases1D[1], iPeriod, iPos );
  //if (save_plots) canvases1D[1]->SaveAs("rpcBxPattern.png");
  if (save_plots) canvases1D[1]->SaveAs("rpcBxPattern_1DSAdata.png");
  //if (save_plots) canvases1D[1]->SaveAs("freeInverseBeta.png");
  //if (save_plots) canvases1D[1]->SaveAs("freeInverseBeta_1DSAdata.png");
  ...
  */
  ...
  for(int i=0; i<Num2DHists; i++){
    ...
    //if (save_plots) canvases2D[i]->SaveAs("p_rpcBxPattern_data.png");
    if (save_plots) canvases2D[i]->SaveAs("p_rpcBxPattern_1DSAdata.png");
    //if (save_plots) canvases2D[i]->SaveAs("p_rpcBxPattern_cosmicData.png");
    //if (save_plots) canvases2D[i]->SaveAs("p_rpcBxPattern_cosmicMC.png");
    //if (save_plots) canvases2D[i]->SaveAs("p_freeInverseBeta_data.png");
    //if (save_plots) canvases2D[i]->SaveAs("p_freeInverseBeta_1DSAdata.png");
    //if (save_plots) canvases2D[i]->SaveAs("p_freeInverseBeta_cosmicData.png");
    //if (save_plots) canvases2D[i]->SaveAs("p_freeInverseBeta_cosmicMC.png");
  }
  ...
  for(int i=Num2DHists; i<2*Num2DHists; i++){
    ...
    CMS_lumi( canvases2D[i], iPeriod, iPos );
    //if (save_plots) canvases2D[i]->SaveAs("p_rpcBxPattern_mchamp500.png");
    if (save_plots) canvases2D[i]->SaveAs("p_rpcBxPattern_mchamp500_1DSA.png");
    //if (save_plots) canvases2D[i]->SaveAs("p_freeInverseBeta_mchamp500.png");
    //if (save_plots) canvases2D[i]->SaveAs("p_freeInverseBeta_mchamp500_1DSA.png");
  }
