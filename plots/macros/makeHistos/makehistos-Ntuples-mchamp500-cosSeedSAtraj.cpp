{
  ...
  TFile f2 ("/home/alimena/histos/mchamp500_710pre7_PRESTA71V3_cosSeedSAreco_SATrajectory/wBxCut_wCavCut_wGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_woPtCut_woChaCut_woEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut_woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root"); //no cuts, 71X, cosmic seed + SA reco

  TFile f3 ("/home/alimena/histos/mchamp500_710pre7_PRESTA71V3_cosSeedSAreco_SATrajectory/wBxCut_wCavCut_wGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_woPtCut_wChaCut_wEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut_woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich_looseDT.root"); //loose dt, 71X, cosmic seed + SA reco
  TFile f4 ("/home/alimena/histos/mchamp500_710pre7_PRESTA71V3_cosSeedSAreco_SATrajectory/wBxCut_wCavCut_wGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_woPtCut_wChaCut_wEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut_woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich_mediumDT.root"); //medium dt, 71X, cosmic seed + SA reco
  TFile f5 ("/home/alimena/histos/mchamp500_710pre7_PRESTA71V3_cosSeedSAreco_SATrajectory/wBxCut_wCavCut_wGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_woPtCut_wChaCut_wEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut_woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich_tightDT.root"); //tight dt, 71X, cosmic seed + SA reco

  TFile f6 ("/home/alimena/histos/mchamp500_710pre7_PRESTA71V3_cosSeedSAreco_SATrajectory/wBxCut_wCavCut_wGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_woPtCut_woChaCut_wEtaCut_woUpperCut_wRpcCut_woDisStCut_woRpcBxCut_woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich_looseRPC.root"); //loose rpc, 71X, cosmic seed + SA reco
  TFile f7 ("/home/alimena/histos/mchamp500_710pre7_PRESTA71V3_cosSeedSAreco_SATrajectory/wBxCut_wCavCut_wGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_woPtCut_woChaCut_wEtaCut_woUpperCut_wRpcCut_woDisStCut_woRpcBxCut_woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich_mediumRPC.root"); //medium rpc, 71X, cosmic seed + SA reco
  //TFile f8 ("/home/alimena/histos/mchamp500_710pre7_PRESTA71V3_cosSeedSAreco_SATrajectory/wBxCut_wCavCut_wGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_woPtCut_woChaCut_wEtaCut_woUpperCut_wRpcCut_woDisStCut_woRpcBxCut_woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich_tightRPC.root"); //tight rpc, 71X, cosmic seed + SA reco
  TFile f8 ("/home/alimena/histos/mchamp500_710pre7_PRESTA71V3_cosSeedSAreco_SATrajectory/wBxCut_wCavCut_wGenMuCut_wSACut_woGenMuMatchedCut_woTriggerCut_woPtCut_wChaCut_wEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut_woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  ...
  */
  ...
  char* LegFile[NumFiles] = {"53X, no cuts","71X, cosSeed, SATraj, no cuts","71X, cosSeed, SATraj, loose DT cuts","71X, cosSeed, SATraj, medium DT cuts","71X, cosSeed, SATraj, tight DT cuts","71X, cosSeed, SATraj, loose RPC cuts","71X, cosSeed, SATraj, medium RPC cuts","71X, cosSeed, SATraj, tight RPC cuts"};
  char LegEntry[100];
  ...
  */
  ...
  float sum71cos = 0.;
  float sum53SA = 0.;
  //const int fileNumber = 2;//loose
  //const int fileNumber = 3;//medium
  const int fileNumber = 4;//tight

  //for(i=30;i<=HAll1D[0][0]->GetNbinsX();i++){
  for(i=20;i<=HAll1D[0][0]->GetNbinsX();i++){
    sum71cosSeedSA += HAll1D[3][0]->GetBinContent(i);
    sum71cosSeedRSA += HAll1D[3][4]->GetBinContent(i);
    sum71cos += HAll1D[3][8]->GetBinContent(i);
    sum53SA += HAll1D[0][0]->GetBinContent(i);
  }
  float fraction71cosSeedSA = (1.0*sum71cosSeedSA)/((Double_t)HAll1D[fileNumber][0]->GetSumOfWeights());
  float fraction71cosSeedRSA = (1.0*sum71cosSeedRSA)/((Double_t)HAll1D[fileNumber][4]->GetSumOfWeights());
  float fraction71cos = (1.0*sum71cos)/((Double_t)HAll1D[fileNumber][8]->GetSumOfWeights());
  ...
  cout<<"sum53SA is: "<<sum53SA<<endl;
  cout<<"sum71cos is: "<<sum71cos<<endl;
  cout<<"sum71cosSeedSA is: "<<sum71cosSeedSA<<endl;



  //2,3,4 // loose, medium, tight
