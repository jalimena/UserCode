{
  ...
  TFile f1 ("/home/alimena/histos/mchamp500_separateEvents_725/wBxCut_wCavCut_woGenMuCut_woSACut_woGenMuMatchedCut_woTriggerCut_woPtCut_woChaCut_woEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut__woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  //TFile f1 ("/home/alimena/histos/mchamp500_separateEvents_725/wBxCut_woCavCut_woGenMuCut_woSACut_woGenMuMatchedCut_woTriggerCut_woPtCut_woChaCut_woEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut__woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  ...
  */
  ...
  char* xtitle2D[Num2DHists] = {"Stopped Particle X [cm]"};
  char* ytitle2D[Num2DHists] = {"Stopped Particle Y [cm]"};
  ...
  */
  for (int a=0; a<NumFiles; a++){
    ...
    HAll1D[a][0]->GetXaxis()->SetRangeUser(0,800);

    HAll2D[a][0]->GetXaxis()->SetRangeUser(-900,900);
    HAll2D[a][0]->GetYaxis()->SetRangeUser(-900,900);
    /*
...
*/
  ...
  */  
  ...
  for (int a=0; a<NumFiles; a++){
    HAll1D[a][0]->GetYaxis()->SetRangeUser(0,2200);
    /*
