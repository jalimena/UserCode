{
  ...
  //TFile f1 ("/home/alimena/histos/tauPrime500/wBxCut_wCavCut_woGenMuCut_woSACut_woGenMuMatchedCut_woTriggerCut_woPtCut_woChaCut_woEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut__woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  //TFile f2 ("/home/alimena/histos/doublyChargedHiggs500/wBxCut_wCavCut_woGenMuCut_woSACut_woGenMuMatchedCut_woTriggerCut_woPtCut_woChaCut_woEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut__woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich_original.root");

  //TFile f1 ("/home/alimena/histos/tauPrime200/wBxCut_wCavCut_woGenMuCut_woSACut_woGenMuMatchedCut_woTriggerCut_woPtCut_woChaCut_woEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut__woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  //TFile f2 ("/home/alimena/histos/doublyChargedHiggs200/wBxCut_wCavCut_woGenMuCut_woSACut_woGenMuMatchedCut_woTriggerCut_woPtCut_woChaCut_woEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut__woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich_original.root");


  //TFile f1 ("/home/alimena/histos/tauPrime500_724/wBxCut_woCavCut_woGenMuCut_woSACut_woGenMuMatchedCut_woTriggerCut_woPtCut_woChaCut_woEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut__woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich_original.root");
  TFile f1 ("/home/alimena/histos/tauPrime500_724/wBxCut_woCavCut_woGenMuCut_woSACut_woGenMuMatchedCut_woTriggerCut_woPtCut_woChaCut_woEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut__woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  TFile f2 ("/home/alimena/histos/doublyChargedHiggs500_5326/wBxCut_woCavCut_woGenMuCut_woSACut_woGenMuMatchedCut_woTriggerCut_woPtCut_woChaCut_woEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut__woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  TFile f3 ("/home/alimena/histos/tauPrime500_724/wBxCut_woCavCut_woGenMuCut_woSACut_woGenMuMatchedCut_woTriggerCut_woPtCut_woChaCut_woEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut__woDtHitsCut_wCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich_original.root");
  //TFile f3 ("/home/alimena/histos/tauPrime500_724/wBxCut_woCavCut_woGenMuCut_woSACut_woGenMuMatchedCut_woTriggerCut_woPtCut_woChaCut_woEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut__woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  ...
  char* plot1D[Num1DHists] = {
    ...
    "mcHMinusMinusPz_", //10
    "mcHMinusMinusPt_", //11
    "mcHMinusMinusEta_", //12
    "mcHMinusMinusPhi_" //13
  };
  ...
  */
  ...
  //char* plot2D[Num2DHists] = {"mcHPlusPlusEta_HMinusMinusEta_","mcHPlusPlusPt_StoppedParticleN_","mcHMinusMinusPt_StoppedParticleN_"};
  //char* xtitle2D[Num2DHists] = {"Generator H^{++} #eta","Generator H^{++} #eta","Generator H^{--} #eta"};
  //char* ytitle2D[Num2DHists] = {"Generator H^{--} #eta","Number of Stopped Particles","Number of Stopped Particles"};
  ...
  for (int i=2*Num2DHists; i<3*Num2DHists; i++){
    sprintf(Cname2D,"canvases2D[%i]",i);
    sprintf(Ctitle2D,"%spreselectedtauPrime",plot2D[i-2*Num2DHists]);
    canvases2D[i] = new TCanvas(Cname2D,Ctitle2D,10,10,575,500);
    canvases2D[i]->SetRightMargin(0.13);
    canvases2D[i]->SetLogz();
    //canvas_style(canvases2D[i]);
  ...
  */
  ...
  for(int i=0; i<Num1DHists; i++){
    HAll1D[0][i]->SetLineColor(1);
    HAll1D[1][i]->SetLineColor(2);
    HAll1D[0][i]->SetLineStyle(1);
    HAll1D[1][i]->SetLineStyle(2);
  }

  HAll2D[0][0]->SetTitle(";Generator mchamp (Q=+2e) p_{T} [GeV];Generator mchamp (Q=-2e) p_{T} [GeV]");
  HAll2D[1][0]->SetTitle(";Generator H^{++} p_{T} [GeV];Generator H^{--} p_{T} [GeV]");

  HAll2D[0][0]->GetXaxis()->SetNdivisions(505);
  HAll2D[1][0]->GetXaxis()->SetNdivisions(505);
  /*
  ...
  */
  ...
  //char* LegFile[NumFiles] = {"mchamps","doubly charged Higgs"};
  //char* LegFile[NumFiles] = {"mchamps","doubly charged Higgs","mchamps after preselection"};
  char* LegFile[NumFiles] = {"mchamps (Q=+2e)","H^{++}","mchamps after preselection"};
  char* LegFile2[NumFiles] = {"mchamps (Q=-2e)","H^{--}","mchamps after preselection"};
  ...
  char LegEntry2[100];
  Leg2 = new TLegend(0.65,0.80,0.90,0.90);
  for (int a=0; a<NumFiles-1; a++){
  //for (int a=1; a<NumFiles; a++){
    sprintf(LegEntry2,"%s",LegFile2[a]);
    Leg2->AddEntry(HAll1D[a][0],LegEntry2,"l");
  }
  ...
  */
  ...
  for(int i=0; i<Num2DHists; i++){
    ...
    scale2D2[i] = (1.0*(Double_t)HAll2D[0][i]->GetSumOfWeights())/((Double_t)HAll2D[2][i]->GetSumOfWeights());

    HAll2D[0][i]->Scale(scale2D0[i]);
    HAll2D[1][i]->Scale(scale2D1[i]);
    HAll2D[2][i]->Scale(scale2D2[i]);
  }  
  ...
  for (int a=0; a<NumFiles; a++){
    HAll1D[a][4]->GetYaxis()->SetRangeUser(.1,30000);
    HAll1D[a][5]->GetYaxis()->SetRangeUser(.1,30000);
    HAll1D[a][11]->GetYaxis()->SetRangeUser(.1,30000);
    HAll1D[a][12]->GetYaxis()->SetRangeUser(.1,30000);
    /*
  ...
  //TString outfile_path = "../txtfiles/DoublyChargedHiggsEventWeights/PtWeights_preselected_mchamp500.txt";
  //TString outfile_path = "../txtfiles/DoublyChargedHiggsEventWeights/EtaWeights_preselected_mchamp500.txt";
  ...
  for(int i=0;i<NumXBins;i++){
    for(int j=0;j<NumYBins;j++){
      ...
      //if(HAll2D[2][0]->GetBinContent(i+1,j+1)!=0.) fraction[i][j]= 1.0*(HAll2D[1][0]->GetBinContent(i+1,j+1))/(HAll2D[2][0]->GetBinContent(i+1,j+1));
      else fraction[i][j] = 0.;
