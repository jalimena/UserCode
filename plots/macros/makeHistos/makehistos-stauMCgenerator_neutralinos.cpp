{
  ...
  char* plot[NumHists] = {"_Nneutralino","_neutralinostatus","_neutralinopt","_neutralinoeta","_neutralinophi","_neutralinovtxX","_neutralinovtxY","_neutralinovtxZ"};
  char* xtitle[NumHists] = {"Number of Neutralinos","MC status of neutralinos","Neutralino Generator p_{T} [GeV]","Neutralino Generator #eta","Neutralino Generator #phi","Neutralino Generator x-coordinate of vertex [cm]","Neutralino Generator y-coordinate of vertex [cm]","Neutralino Generator z-coordinate of vertex [cm]"};
  ...
  for (int a=0; a<NumFiles; a++){
    ...
    //HAll[a][1]->GetXaxis()->SetRangeUser(-20,100);
    HAll[a][1]->GetXaxis()->SetRangeUser(1000000,1000030);
    HAll[a][2]->GetXaxis()->SetRangeUser(0,100);
    HAll[a][3]->GetXaxis()->SetRangeUser(-4.5,4.5);
    HAll[a][4]->GetXaxis()->SetRangeUser(-3.5,3.5);
    HAll[a][5]->GetXaxis()->SetRangeUser(-3000,3000);
    HAll[a][6]->GetXaxis()->SetRangeUser(-3000,3000);
    HAll[a][7]->GetXaxis()->SetRangeUser(-6000,6000);
  }    
  ...
  for(int i=0; i<NumHists; i++){
    ...
    sprintf(canvasesEPS,"../plots/stauMCgenerator/neutralinos/%s.eps",plot[i]);
