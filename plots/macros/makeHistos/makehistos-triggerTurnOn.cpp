{
  ...
  TFile f1("/home/alimena/histos/TriggerTurnOnHistos_NoBPTX_Run2012C_ControlTrigger.root"); 
  ...
  char* plot1D[Num1DHists] = {
    "muStandAlonePt_numerator_", 
    "muStandAlonePt_denominator_"
  };
  ...
  eff_graph->SetTitle(";StandAlone Muon p_{T} [GeV];Efficiency");
