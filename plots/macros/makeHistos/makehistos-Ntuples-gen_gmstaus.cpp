{
  ...
  TFile f3 ("/home/alimena/histos/gmstau494_gravitinop0001_reducedNtuples_724/wBxCut_woCavCut_woGenMuCut_woSACut_woGenMuMatchedCut_woTriggerCut_woPtCut_woChaCut_woEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut__woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  ...
  */
  ...
  for (int a=0; a<NumFiles; a++){
    ...
    HAll1D[a][11]->GetYaxis()->SetRangeUser(0,1200);
    ...
    HAll1D[a][5]->GetYaxis()->SetRangeUser(1,1000000);
