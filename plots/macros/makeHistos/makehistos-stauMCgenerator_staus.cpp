{
  ...
  char* plot[NumHists] = {"_Nstau","_staustatus","_staupt","_staueta","_stauphi","_stauvtxX","_stauvtxY","_stauvtxZ"};
  char* xtitle[NumHists] = {"Number of Staus","MC status of staus","Stau Generator p_{T} [GeV]","Stau Generator #eta","Stau Generator #phi","Stau Generator x-coordinate of vertex [cm]","Stau Generator y-coordinate of vertex [cm]","Stau Generator z-coordinate of vertex [cm]"};
  ...
  for(int i=0; i<NumHists; i++){
    ...
    sprintf(canvasesEPS,"../plots/stauMCgenerator/staus/%s.eps",plot[i]);
