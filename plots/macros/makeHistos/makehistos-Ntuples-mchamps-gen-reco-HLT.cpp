{
  ...
  /*
  //TFile f1 ("/home/alimena/histos/mchamp500_723patch1/wBxCut_wCavCut_wGenMuCut_wSACut_woGenMuMatchedCut_wTriggerCut_woPtCut_woChaCut_woEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut__woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root"); //gen, reco
  TFile f1 ("/home/alimena/histos/mchamp500_723patch1/wBxCut_wCavCut_wGenMuCut_wSACut_woGenMuMatchedCut_woTriggerCut_woPtCut_wChaCut_woEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut__woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  TFile f2 ("/home/alimena/histos/Triggers_csmt/histosHltAnalyzer_mchamp500_csmt_L1MuOpenSeeds.root"); //HLT
  */



  TFile f1 ("/home/alimena/histos/mchamp500_separateEvents_725/wBxCut_wCavCut_wGenMuCut_wSACut_woGenMuMatchedCut_woTriggerCut_woPtCut_wChaCut_woEtaCut_woUpperCut_woRpcCut_woDisStCut_woRpcBxCut__woDtHitsCut_woCscHitsCut_woDtInvBetaCut_woTimeInOutCut_woOppEtaCut_woOppPhiCut_woTightPhi_woCosEnrich.root");
  ...
  char* plot1D[Num1DHists] = {
    "mcMuonPt_hist", //1
    "muDisplacedStandAlonePt_hist", //1
    //"demo/ptTriggerMuon_L2Mu20_NoVertex_3Sta_NoBPTX3BX_NoHalo"
    /*
  ...
  */
  ...
  for(int i=0; i<Num1DHists-1; i++){
    ...
    sprintf(oldH1Dname,"%s",plot1D[i]);
    if(i==0) HAll1D[0][0] = (TH1D*) f1.Get(oldH1Dname);
    if(i==1) HAll1D[0][1] = (TH1D*) f1.Get(oldH1Dname);
  ...
  sprintf(oldH1Dname,"%s",plot1D[2]);
  HAll1D[1][2] = (TH1D*) f2.Get(oldH1Dname);
  ...
  */
  ...
  int color[Num1DHists] = {1,2};//,4};//,6,8,11};//,12,13,14};
  int style[Num1DHists] = {1,2};//,3};//,4,5,6};//,7,8,9};
  int marker[Num1DHists] = {20,21};//,22};//,23,24,25};//,26,27,28};
  char axistitles[200];
  //for(int a=0; a<NumFiles; a++){
  //for(int i=0; i<Num1DHists; i++){
  ...
  HAll1D[0][0]->SetTitle(";p_{T} [GeV];Events");
  HAll1D[0][1]->SetTitle(";p_{T} [GeV];Events");
  HAll1D[1][2]->SetTitle(";p_{T} [GeV];Events");
  h1_style(HAll1D[0][0],3,color[0],style[0],1001,50,-1111.,-1111.,510,510,marker[0],color[0],1,1);
  h1_style(HAll1D[0][1],3,color[1],style[1],1001,50,-1111.,-1111.,510,510,marker[1],color[1],1,1);
  h1_style(HAll1D[1][2],3,color[2],style[2],1001,50,-1111.,-1111.,510,510,marker[2],color[2],1,1);
  ...
  */
  ...
  //char* LegFile[NumFiles] = {"H^{++} 100 GeV","H^{++} 500 GeV","H^{++} 1000 GeV"};
  //char* LegFile[Num1DHists] = {"Generator Muon","Displaced SA Muon","Displaced L2 Muon"};
  char* LegFile[Num1DHists] = {"Generator Muon","Displaced SA Muon"};
  ...
  //Leg1->AddEntry(HAll1D[1][2],LegEntry,"l");
    //}
  ...
  */
  ...
  scalef1[0] = (1.0*(Double_t)HAll1D[0][0]->GetSumOfWeights())/((Double_t)HAll1D[0][1]->GetSumOfWeights());
  scalef2[0] = (1.0*(Double_t)HAll1D[0][0]->GetSumOfWeights())/((Double_t)HAll1D[1][2]->GetSumOfWeights());
  
  HAll1D[0][1]->Scale(scalef1[0]);
  HAll1D[1][2]->Scale(scalef2[0]);
  ...
  */
  ...
  //for(int i=0; i<17; i++){
    ...
    */
    ...
    HAll1D[0][0]->Draw("hists");
    HAll1D[0][1]->Draw("histsames");
    //HAll1D[1][2]->Draw("histsames");
