...
// Thu Mar 29 14:36:54 2012 by ROOT version 5.27/06b
// from TTree HltTree/
// found on file: /afs/cern.ch/user/j/jalimena/private/keep/stau_HLTntuples/openhlt_stau100.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           hltpftauSignalTrToPFTauMatch[1];   //[NoHLTPFTausSignal]
   Float_t         HLTPFTauSignalTrDz[1];   //[NoHLTPFTausSignal]
   Float_t         HLTPFTauSignalTrPt[1];   //[NoHLTPFTausSignal]
   Int_t           NoHLTPFTausIso;
   Int_t           hltpftauIsoTrToPFTauMatch[1];   //[NoHLTPFTausIso]
   Float_t         HLTPFTauIsoTrDz[1];   //[NoHLTPFTausIso]
   Float_t         HLTPFTauIsoTrPt[1];   //[NoHLTPFTausIso]
   Int_t           NrecoJetGen;
   Int_t           NrecoTowCal;
   Int_t           NrecoJetCal;
   ...
   Int_t           NohJetCal;
   Float_t         ohJetCalPt[4];   //[NohJetCal]
   Float_t         ohJetCalPhi[4];   //[NohJetCal]
   Float_t         ohJetCalEta[4];   //[NohJetCal]
   Float_t         ohJetCalE[4];   //[NohJetCal]
   Float_t         ohJetCalEMF[4];   //[NohJetCal]
   Float_t         ohJetCalN90[4];   //[NohJetCal]
   Float_t         ohJetCalN90hits[4];   //[NohJetCal]
   Int_t           NohJetCorCal;
   Float_t         ohJetCorCalPt[2];   //[NohJetCorCal]
   Float_t         ohJetCorCalPhi[2];   //[NohJetCorCal]
   Float_t         ohJetCorCalEta[2];   //[NohJetCorCal]
   Float_t         ohJetCorCalE[2];   //[NohJetCorCal]
   Float_t         ohJetCorCalEMF[2];   //[NohJetCorCal]
   Float_t         ohJetCorCalN90[2];   //[NohJetCorCal]
   Float_t         ohJetCorCalN90hits[2];   //[NohJetCorCal]
   Int_t           NohJetCorL1L2L3Cal;
   Float_t         ohJetCorL1L2L3CalPt[2];   //[NohJetCorL1L2L3Cal]
   Float_t         ohJetCorL1L2L3CalPhi[2];   //[NohJetCorL1L2L3Cal]
   Float_t         ohJetCorL1L2L3CalEta[2];   //[NohJetCorL1L2L3Cal]
   Float_t         ohJetCorL1L2L3CalE[2];   //[NohJetCorL1L2L3Cal]
   Float_t         ohJetCorL1L2L3CalEMF[2];   //[NohJetCorL1L2L3Cal]
   Float_t         ohJetCorL1L2L3CalN90[2];   //[NohJetCorL1L2L3Cal]
   Float_t         ohJetCorL1L2L3CalN90hits[2];   //[NohJetCorL1L2L3Cal]
   Float_t         recoJetGenPt[4];   //[NrecoJetGen]
   Float_t         recoJetGenPhi[4];   //[NrecoJetGen]
   Float_t         recoJetGenEta[4];   //[NrecoJetGen]
   Float_t         recoJetGenE[4];   //[NrecoJetGen]
   Float_t         recoTowEt[3];   //[NrecoTowCal]
   Float_t         recoTowEta[3];   //[NrecoTowCal]
   Float_t         recoTowPhi[3];   //[NrecoTowCal]
   Float_t         recoTowE[3];   //[NrecoTowCal]
   Float_t         recoTowEm[3];   //[NrecoTowCal]
   Float_t         recoTowHad[3];   //[NrecoTowCal]
   Float_t         recoTowOE[3];   //[NrecoTowCal]
   Float_t         recoMetCal;
   ...
   Int_t           NohTau;
   Float_t         ohTauEta[2];   //[NohTau]
   Float_t         ohTauPhi[2];   //[NohTau]
   Float_t         ohTauPt[2];   //[NohTau]
   Float_t         ohTauEiso[2];   //[NohTau]
   Float_t         ohTauL25Tpt[2];   //[NohTau]
   Int_t           ohTauL3Tiso[2];   //[NohTau]
   Int_t           NohpfTau;
   Float_t         ohpfTauPt[13];   //[NohpfTau]
   Int_t           ohpfTauProngs[13];   //[NohpfTau]
   Float_t         ohpfTauEta[13];   //[NohpfTau]
   Float_t         ohpfTauPhi[13];   //[NohpfTau]
   Float_t         ohpfTauLeadTrackPt[13];   //[NohpfTau]
   Float_t         ohpfTauLeadPionPt[13];   //[NohpfTau]
   Float_t         ohpfTauTrkIso[13];   //[NohpfTau]
   Float_t         ohpfTauGammaIso[13];   //[NohpfTau]
   Float_t         ohpfTauJetPt[13];   //[NohpfTau]
   Int_t           NohpfTauTightCone;
   Float_t         ohpfTauTightConePt[13];   //[NohpfTauTightCone]
   Int_t           ohpfTauTightConeProngs[13];   //[NohpfTauTightCone]
   Float_t         ohpfTauTightConeEta[13];   //[NohpfTauTightCone]
   Float_t         ohpfTauTightConePhi[13];   //[NohpfTauTightCone]
   Float_t         ohpfTauTightConeLeadTrackPt[13];   //[NohpfTauTightCone]
   Float_t         ohpfTauTightConeLeadPionPt[13];   //[NohpfTauTightCone]
   Float_t         ohpfTauTightConeTrkIso[13];   //[NohpfTauTightCone]
   Float_t         ohpfTauTightConeGammaIso[13];   //[NohpfTauTightCone]
   Float_t         ohpfTauTightConeJetPt[13];   //[NohpfTauTightCone]
   Int_t           NRecoPFTau;
   ...
   Float_t         pfMHT;
   Int_t           NohPFJet;
   Float_t         pfJetPt[13];   //[NohPFJet]
   Float_t         pfJetE[13];   //[NohPFJet]
   Float_t         pfJetEta[13];   //[NohPFJet]
   Float_t         pfJetPhi[13];   //[NohPFJet]
   Int_t           nrpj;
   ...
   Int_t           NohBJetL2;
   Float_t         ohBJetL2Energy[4];   //[NohBJetL2]
   Float_t         ohBJetL2Et[4];   //[NohBJetL2]
   Float_t         ohBJetL2Pt[4];   //[NohBJetL2]
   Float_t         ohBJetL2Eta[4];   //[NohBJetL2]
   Float_t         ohBJetL2Phi[4];   //[NohBJetL2]
   Int_t           NohBJetL2Corrected;
   Float_t         ohBJetL2CorrectedEnergy[2];   //[NohBJetL2Corrected]
   Float_t         ohBJetL2CorrectedEt[2];   //[NohBJetL2Corrected]
   Float_t         ohBJetL2CorrectedPt[2];   //[NohBJetL2Corrected]
   Float_t         ohBJetL2CorrectedEta[2];   //[NohBJetL2Corrected]
   Float_t         ohBJetL2CorrectedPhi[2];   //[NohBJetL2Corrected]
   Float_t         ohBJetIPL25Tag[2];   //[NohBJetL2Corrected]
   Float_t         ohBJetIPL3Tag[2];   //[NohBJetL2Corrected]
   Float_t         ohBJetIPL25TagSingleTrack[2];   //[NohBJetL2Corrected]
   Float_t         ohBJetIPL3TagSingleTrack[2];   //[NohBJetL2Corrected]
   Int_t           ohBJetPerfL25Tag[2];   //[NohBJetL2Corrected]
   Int_t           ohBJetPerfL3Tag[2];   //[NohBJetL2Corrected]
   Int_t           NrecoElec;
   ...
   Float_t         ohMuL2VtxZ[1];   //[NohMuL2]
   Int_t           ohMuL2Nhits[1];   //[NohMuL2]
   Int_t           ohMuL2Nchambers[1];   //[NohMuL2]
   Int_t           ohMuL2Nstat[1];   //[NohMuL2]
   Int_t           ohMuL2L1idx[1];   //[NohMuL2]
   Int_t           NohMuL3;
   ...
   Int_t           ohMuL3Trk10Iso[1];   //[NohMuL3]
   Float_t         ohMuL3Dr[1];   //[NohMuL3]
   Float_t         ohMuL3Dz[1];   //[NohMuL3]
   Float_t         ohMuL3VtxZ[1];   //[NohMuL3]
   Int_t           ohMuL3Nhits[1];   //[NohMuL3]
   Float_t         ohMuL3NormChi2[1];   //[NohMuL3]
   Int_t           ohMuL3Ntrackerhits[1];   //[NohMuL3]
   Int_t           ohMuL3Nmuonhits[1];   //[NohMuL3]
   Int_t           ohMuL3L2idx[1];   //[NohMuL3]
   Int_t           NohOniaPixel;
   Float_t         ohOniaPixelPt[1];   //[NohOniaPixel]
   Float_t         ohOniaPixelPhi[1];   //[NohOniaPixel]
   Float_t         ohOniaPixelEta[1];   //[NohOniaPixel]
   Int_t           ohOniaPixelChg[1];   //[NohOniaPixel]
   Float_t         ohOniaPixelDr[1];   //[NohOniaPixel]
   Float_t         ohOniaPixelDz[1];   //[NohOniaPixel]
   Int_t           ohOniaPixelHits[1];   //[NohOniaPixel]
   Float_t         ohOniaPixelNormChi2[1];   //[NohOniaPixel]
   Int_t           NohOniaTrack;
   Float_t         ohOniaTrackPt[1];   //[NohOniaTrack]
   Float_t         ohOniaTrackPhi[1];   //[NohOniaTrack]
   Float_t         ohOniaTrackEta[1];   //[NohOniaTrack]
   Int_t           ohOniaTrackChg[1];   //[NohOniaTrack]
   Float_t         ohOniaTrackDr[1];   //[NohOniaTrack]
   Float_t         ohOniaTrackDz[1];   //[NohOniaTrack]
   Int_t           ohOniaTrackHits[1];   //[NohOniaTrack]
   Float_t         ohOniaTrackNormChi2[1];   //[NohOniaTrack]
   Int_t           NohMuL2NoVtx;
   Float_t         ohMuL2NoVtxPt[1];   //[NohMuL2NoVtx]
   Float_t         ohMuL2NoVtxPhi[1];   //[NohMuL2NoVtx]
   Float_t         ohMuL2NoVtxEta[1];   //[NohMuL2NoVtx]
   Int_t           ohMuL2NoVtxChg[1];   //[NohMuL2NoVtx]
   Float_t         ohMuL2NoVtxPtErr[1];   //[NohMuL2NoVtx]
   Float_t         ohMuL2NoVtxDr[1];   //[NohMuL2NoVtx]
   Float_t         ohMuL2NoVtxDz[1];   //[NohMuL2NoVtx]
   Int_t           ohMuL2NoVtxNhits[1];   //[NohMuL2NoVtx]
   Int_t           ohMuL2NoVtxNchambers[1];   //[NohMuL2NoVtx]
   Int_t           ohMuL2NoVtxL1idx[1];   //[NohMuL2NoVtx]
   Int_t           NohDiMu;
   Float_t         ohDiMuDCA[1];   //[NohDiMu]
   Int_t           ohDiMu1st[1];   //[NohDiMu]
   Int_t           ohDiMu2nd[1];   //[NohDiMu]
   Int_t           NohDiMuVtx;
   ...
   Int_t           NohTrackerMuon;
   Float_t         ohTrackerMuonPt[1];   //[NohTrackerMuon]
   Float_t         ohTrackerMuonPhi[1];   //[NohTrackerMuon]
   Float_t         ohTrackerMuonEta[1];   //[NohTrackerMuon]
   Int_t           ohTrackerMuonChg[1];   //[NohTrackerMuon]
   Int_t           ohTrackerMuonNhits[1];   //[NohTrackerMuon]
   Int_t           NpfMuon;
   Float_t         pfMuonPt[1];   //[NpfMuon]
   Float_t         pfMuonPhi[1];   //[NpfMuon]
   Float_t         pfMuonEta[1];   //[NpfMuon]
   Float_t         pfMuonEt[1];   //[NpfMuon]
   Float_t         pfMuonE[1];   //[NpfMuon]
   Float_t         pfMuonCharge[1];   //[NpfMuon]
   ...
   Int_t           NMCpart;
   Int_t           MCpid[16];   //[NMCpart]
   Int_t           MCstatus[16];   //[NMCpart]
   Float_t         MCvtxX[16];   //[NMCpart]
   Float_t         MCvtxY[16];   //[NMCpart]
   Float_t         MCvtxZ[16];   //[NMCpart]
   Float_t         MCpt[16];   //[NMCpart]
   Float_t         MCeta[16];   //[NMCpart]
   Float_t         MCphi[16];   //[NMCpart]
   Float_t         MCPtHat;
   Int_t           MCmu3;
   Int_t           MCel3;
   Int_t           MCbb;
   ...
   TBranch        *b_NohTrackerMuon;   //!
   TBranch        *b_ohTrackerMuonPt;   //!
   TBranch        *b_ohTrackerMuonPhi;   //!
   TBranch        *b_ohTrackerMuonEta;   //!
   TBranch        *b_ohTrackerMuonChg;   //!
   TBranch        *b_ohTrackerMuonNhits;   //!
   TBranch        *b_NpfMuon;   //!
   TBranch        *b_pfMuonPt;   //!
   TBranch        *b_pfMuonPhi;   //!
   TBranch        *b_pfMuonEta;   //!
   ...
   TBranch        *b_filter_step;   //!
   TBranch        *b_filter_step_Prescl;   //!
   TBranch        *b_generation_step;   //!
   TBranch        *b_generation_step_Prescl;   //!
   TBranch        *b_simulation_step;   //!
   TBranch        *b_simulation_step_Prescl;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/cern.ch/user/j/jalimena/private/keep/stau_HLTntuples/openhlt_stau100.root");
      if (!f) {
         f = new TFile("/afs/cern.ch/user/j/jalimena/private/keep/stau_HLTntuples/openhlt_stau100.root");
      }
...
void HltTree::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("NohTrackerMuon", &NohTrackerMuon, &b_NohTrackerMuon);
   fChain->SetBranchAddress("ohTrackerMuonPt", ohTrackerMuonPt, &b_ohTrackerMuonPt);
   fChain->SetBranchAddress("ohTrackerMuonPhi", ohTrackerMuonPhi, &b_ohTrackerMuonPhi);
   fChain->SetBranchAddress("ohTrackerMuonEta", ohTrackerMuonEta, &b_ohTrackerMuonEta);
   fChain->SetBranchAddress("ohTrackerMuonChg", ohTrackerMuonChg, &b_ohTrackerMuonChg);
   fChain->SetBranchAddress("ohTrackerMuonNhits", ohTrackerMuonNhits, &b_ohTrackerMuonNhits);
   ...
   fChain->SetBranchAddress("filter_step", &filter_step, &b_filter_step);
   fChain->SetBranchAddress("filter_step_Prescl", &filter_step_Prescl, &b_filter_step_Prescl);
   fChain->SetBranchAddress("generation_step", &generation_step, &b_generation_step);
   fChain->SetBranchAddress("generation_step_Prescl", &generation_step_Prescl, &b_generation_step_Prescl);
   fChain->SetBranchAddress("simulation_step", &simulation_step, &b_simulation_step);
   fChain->SetBranchAddress("simulation_step_Prescl", &simulation_step_Prescl, &b_simulation_step_Prescl);
