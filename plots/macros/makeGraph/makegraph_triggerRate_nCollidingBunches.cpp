{
  ...
  const Int_t n_data2017_25ns = 3;
  Float_t bunches_data2017_25ns[n_data2017_25ns] = {589,   973, 1213}; //number of colliding bunches
  Float_t rate_data2017_25ns[n_data2017_25ns]    = {16.0, 13.4, 12.6}; //2017 25 ns, /cdaq/physics/Run2017/2e34/v1.0.0/HLT/V6 rate of HLT_L2Mu40_NoVertex_3Sta_NoBPTX3BX (Hz), use 3.8T runs only
  Float_t bunches_data2017_25ns_error[n_data2017_25ns] = {0,0,0};
  Float_t rate_data2017_25ns_error[n_data2017_25ns] = {1,1,1}; //determined from width of rate plot in WBM, L2Mu40
