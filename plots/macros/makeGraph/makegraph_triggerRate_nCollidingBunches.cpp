{
  ...
  Float_t bunches_data2022_25ns_error[n_data2022_25ns] = {0,0,0, 0,0,0, 0,0};
  Float_t rate_data2022_25ns_error[n_data2022_25ns] = {2,1.5,1.5, 1.5, 1, 1, 1, 1}; //determined from width of rate plot in WBM, L2Mu40
  ...
  TF1* fit1 = new TF1("fit1","[0]*x+[1]",bunches_data2022_25ns[0],bunches_data2022_25ns[n_data2022_25ns-1]);
  fit1->SetLineColor(2);
  graph_data2022_25ns->Fit("fit1","R");

  TF1* fit1ext = new TF1("fit1ext","[0]*x+[1]",bunches_data2022_25ns[n_data2022_25ns-1],3000);
