{
  ...
  //TH2* h1=new TH2F("h1","",15,0,1500,10,0,0.5);
  TH2* h1=new TH2F("h1","",11,0,1100,10,0,0.5);
  h1->SetStats(kFALSE);
  ...
  Float_t stop_stoppingEfficiency[n_stop_massPoints] = {0.047,0.048,0.046,0.044,0.046,0.048,0.043,0.044,0.041};
  ...
  graph_stop_stoppingEfficiency->SetTitle(";Mass [GeV];Trigger Efficiency");
  ...
  Float_t gluino_stoppingEfficiency[n_gluino_massPoints] = {0.007,0.008,0.007,0.004,0.000,0.003,0.007,0.007,0.000,0.003,0.006,0.003,0.006};
  ...
  graph_gluino_stoppingEfficiency->SetTitle(";Mass [GeV];Trigger Efficiency");
  ...
  Float_t mchamp_stoppingEfficiency[n_mchamp_massPoints] = {0.170,0.174,0.174,0.172,0.172,0.172,0.171,0.173,0.169,0.168};
  ...
  graph_mchamp_stoppingEfficiency->SetTitle(";Mass [GeV];Trigger Efficiency");
  ...
  Float_t mchampPlus_stoppingEfficiency[n_mchampPlus_massPoints] = {0.089,0.095,0.087,0.090,0.091,0.085,0.086,0.088,0.085,0.085};
  ...
  graph_mchampPlus_stoppingEfficiency->SetTitle(";Mass [GeV];Trigger Efficiency");
  ...
  Float_t gmstau_stoppingEfficiency[n_gmstau_massPoints] = {0.022,0.029,0.029,0.045,0.044,0.042,0.049,0.040,0.044};
  ...
  graph_gmstau_stoppingEfficiency->SetTitle(";Mass [GeV];Trigger Efficiency");
  ...
  Float_t ppstau_stoppingEfficiency[n_ppstau_massPoints] = {0.022,0.022,0.024,0.019,0.033,0.026,0.027,0.023,0.012};
  ...
  graph_ppstau_stoppingEfficiency->SetTitle(";Mass [GeV];Trigger Efficiency");
  ...
  if(save_plots) c1->SaveAs("../plots/StoppedHSCPMuon/RecoData/signalMC/efficiencies/triggerEfficiency.eps");
