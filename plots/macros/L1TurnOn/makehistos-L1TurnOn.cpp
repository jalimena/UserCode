{
  ...
  //TFile f1("/home/alimena/histos/histos_L1TurnOn_NoBPTX_208487.root"); 

  //TFile f1("/home/alimena/histos/L1TurnOn/NoBPTX_208487/histos.root"); 
  TFile f1("/home/alimena/histos/L1TurnOn/SingleElectron_208487/histos.root"); 
  ...
  char* plot1D[Num1DHists] = {
    "hltL1TurnOnAnalyzer/l2MuPt_numerator_", 
    "hltL1TurnOnAnalyzer/l2MuPt_denominator_"
  };
  ...
  for (int a=0; a<NumFiles; a++){
    for(int i=0; i<Num1DHists; i++){
      //HAll1D[a][0]->GetXaxis()->SetRangeUser(-50,50);
      //HAll1D[a][i]->Rebin(20);
    }    
  }
  ...
  eff_graph->SetTitle(";L2 Muon p_{T} [GeV];Efficiency");
