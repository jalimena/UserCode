...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
        'file:/afs/cern.ch/work/j/jalimena/CMSSW_7_2_2_patch2/src/HLTrigger/Configuration/test/outputA_csmt_DisplacedSUSY800_p2d0.root',
    )
)
...
process.TFileService = cms.Service( "TFileService",
                                    fileName = cms.string( 'histosHltAnalyzer_DisplacedSUSY800_p2d0_csmt.root' )
                                    )
