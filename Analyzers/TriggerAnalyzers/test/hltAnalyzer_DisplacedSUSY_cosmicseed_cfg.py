...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
        'file:/afs/cern.ch/work/j/jalimena/CMSSW_7_2_1_patch4/src/HLTrigger/Configuration/test/outputA_cosmicSeed_DisplacedSUSY.root'
    )
)
...
process.TFileService = cms.Service( "TFileService",
                                    fileName = cms.string( 'histosHltAnalyzer_DisplacedSUSY_cosmicseed.root' )
                                    )
