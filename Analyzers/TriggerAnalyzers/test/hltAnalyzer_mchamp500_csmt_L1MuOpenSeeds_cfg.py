...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
        'file:/afs/cern.ch/work/j/jalimena/CMSSW_7_2_2_patch2/src/HLTrigger/Configuration/test/outputA_csmt_L1MuOpenSeeds_mchamp500.root'
    )
)
...
process.TFileService = cms.Service( "TFileService",
                                    fileName = cms.string( 'histosHltAnalyzer_mchamp500_csmt_L1MuOpenSeeds.root' )
                                    )
