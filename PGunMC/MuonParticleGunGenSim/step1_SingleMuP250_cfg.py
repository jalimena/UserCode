...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/Generator/python/SingleMuP1000_pythia8_cfi.py nevts:50'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step1_SingleMuP250.root'),
...
process.generator = cms.EDFilter("Pythia8PGun",
				 PGunParameters = cms.PSet(
		MaxP = cms.double(250.01),
		MinP = cms.double(249.99),
		...
		MinPhi = cms.double(-3.14159265359) ## in radians
				 ...
				 psethack = cms.string('single mu p 250'),
