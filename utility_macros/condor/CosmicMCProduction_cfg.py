...
# with command line options: UndergroundCosmicMu_cfi.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT:7E33v4,RAW2DIGI,RECO -n -1 --mc --conditions COSMC_53_PEAC::All --eventcontent RECO --datatier RECO --scenario cosmics --fileout file:full.root --no_exec --python_filename step23_ALCARECO_PEAK38T_cfg_FULL.py
...
# Not produced by default in the cosmic reco sequence
process.reconstructionCosmics*=process.refittedStandAloneMuons
